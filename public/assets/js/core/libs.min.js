...
!(function (e, t) {
                        ...
                        (r = e[t]),
                            "__proto__" !== t &&
                                ...
                                (c && r && (w.isPlainObject(r) || (i = Array.isArray(r)))
                                    ? ((n = s[t]), (o = i && !Array.isArray(n) ? [] : i || w.isPlainObject(n) ? n : {}), (i = !1), (s[t] = w.extend(c, o, r)))
                                    : void 0 !== r && (s[t] = r));
            return s;
        }),
        w.extend({
    ...
    var S =
        ...
        (function (e) {
            ...
            try {
                O.apply((L = N.call(w.childNodes)), w.childNodes), L[w.childNodes.length].nodeType;
            } catch (e) {
                O = {
                    apply: L.length
                        ? function (e, t) {
                ...
                if (!i && (d(t), (t = t || h), g)) {
                    ...
                    if (n.qsa && !A[e + " "] && (!m || !m.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                        if (((v = e), (y = t), 1 === w && (U.test(e) || z.test(e)))) {
                            for (((y = (ee.test(e) && ve(t.parentNode)) || t) === t && n.scope) || ((u = t.getAttribute("id")) ? (u = u.replace(re, ie)) : t.setAttribute("id", (u = _))), a = (p = s(e)).length; a--; )
            ...
            function Se(e, t, n, r, i, o) {
                return (
                    ...
                    ce(function (o, s, a, l) {
                        ...
                        } else (v = xe(v === s ? v.splice(p, v.length) : v)), i ? i(null, s, v, l) : O.apply(s, v);
                    })
                );
            }
            function Te(e) {
                for (
                    ...
                    if ((n = r.relative[e[l].type])) d = [_e(we(d), n)];
                        ...
                        if ((n = r.filter[e[l].type].apply(null, e[l].matches))[_]) {
                            ...
                            return Se(l > 1 && we(d), l > 1 && be(e.slice(0, l - 1).concat({ value: " " === e[l - 2].type ? "*" : "" })).replace(B, "$1"), n, l < i && Te(e.slice(l, i)), i < o && Te((e = e.slice(i))), i < o && be(e));
                        }
                        d.push(n);
                    }
                return we(d);
            ...
            return (
                ...
                (s = ae.tokenize = function (e, t) {
                    ...
                    for (a = e, l = [], c = r.preFilter; a; ) {
                        for (s in ((n && !(i = $.exec(a))) || (i && (a = a.slice(i[0].length) || a), l.push((o = []))),
                        (n = !1),
                        (i = z.exec(a)) && ((n = i.shift()), o.push({ value: n, type: i[0].replace(B, " ") }), (a = a.slice(n.length))),
                        r.filter))
                            !(i = J[s].exec(a)) || (c[s] && !(i = c[s](i))) || ((n = i.shift()), o.push({ value: n, type: s, matches: i }), (a = a.slice(n.length)));
                        if (!n) break;
                    }
                                ...
                                var n = t.length > 0,
                                    ...
                                    o = function (o, s, a, l, u) {
                                        var f,
                                            ...
                                            C = S.length;
                                        for (u && (c = s == h || s || u); y !== C && null != (f = S[y]); y++) {
                                            if (i && f) {
                                        ...
                                        if (((v += y), n && y !== v)) {
                                            ...
                                            O.apply(l, _), u && !o && _.length > 0 && v + t.length > 1 && ae.uniqueSort(l);
                                        }
                                        return u && ((x = T), (c = w)), b;
                                    };
                                return n ? ce(o) : o;
                ...
                (l = ae.select = function (e, t, n, i) {
                    ...
                    if (((n = n || []), 1 === h.length)) {
                        ...
                        for (o = J.needsContext.test(e) ? 0 : l.length; o-- && ((c = l[o]), !r.relative[(u = c.type)]); )
    ...
    ((w.fn.init = function (e, t, n) {
        ...
        if (((n = n || L), "string" == typeof e)) {
            ...
            if (r[1]) {
                if (((t = t instanceof w ? t[0] : t), w.merge(this, w.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : m, !0)), E.test(r[1]) && w.isPlainObject(t))) for (r in t) p(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                return this;
            }
        ...
        w.each(
            ...
            function (e, t) {
                w.fn[e] = function (n, r) {
                    ...
                    return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = w.filter(r, i)), this.length > 1 && (O[e] || w.uniqueSort(i), j.test(e) && i.reverse()), this.pushStack(i);
                };
            }
        );
    var P = /[^\x20\t\r\n\f]+/g;
                ...
                var n = [
                    ...
                    i = {
                        ...
                        then: function (t, r, i) {
                                        ...
                                        c = function () {
                                            ...
                                            if (!(t < o)) {
                                                ...
                                                (c = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                    p(c)
                                                        ? i
                                                            ? c.call(e, s(o, n, F, i), s(o, n, R, i))
                                                            : (o++, c.call(e, s(o, n, F, i), s(o, n, R, i), s(o, n, F, n.notifyWith)))
                                                        : (r !== F && ((a = void 0), (l = [e])), (i || n.resolveWith)(a, l));
                                            }
                                        },
                                        u = i
                                            ? c
                                            : function () {
                                                  try {
                                                      ...
                                                      w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, u.stackTrace), t + 1 >= o && (r !== R && ((a = void 0), (l = [e])), n.rejectWith(a, l));
                                                  }
                                              };
                            ...
                            return w
                                .Deferred(function (e) {
                                    n[0][3].add(s(0, e, p(i) ? i : F, e.notifyWith)), n[1][3].add(s(0, e, p(t) ? t : F)), n[2][3].add(s(0, e, p(r) ? r : R));
                                })
                                .promise();
                        },
                        promise: function (e) {
    ...
    var B = function (e, t, n, r, i, o, s) {
            var a = 0,
                l = e.length,
                c = null == n;
            if ("object" === b(n)) for (a in ((i = !0), n)) B(e, t, a, n[a], !0, o, s);
            else if (
                void 0 !== r &&
                ((i = !0),
                p(r) || (s = !0),
    ...
    function ae(e, t, n, r) {
        ...
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; s--; ) w.style(e, t, u + c), (1 - o) * (1 - (o = a() / l || 0.5)) <= 0 && (s = 0), (u /= o);
    ...
    function ue(e, t) {
        for (var n, r, i = [], o = 0, s = e.length; o < s; o++)
            (r = e[o]).style &&
                ((n = r.style.display),
                t ? ("none" === n && ((i[o] = Y.get(r, "display") || null), i[o] || (r.style.display = "")), "" === r.style.display && se(r) && (i[o] = ce(r))) : "none" !== n && ((i[o] = "none"), Y.set(r, "display", n)));
        ...
        for (var o, s, a, l, c, u, f = t.createDocumentFragment(), d = [], h = 0, p = e.length; h < p; h++)
            if ((o = e[h]) || 0 === o)
                if ("object" === b(o)) w.merge(d, o.nodeType ? [o] : o);
                    ...
                    for (s = s || f.appendChild(t.createElement("div")), a = (pe.exec(o) || ["", ""])[1].toLowerCase(), l = me[a] || me._default, s.innerHTML = l[1] + w.htmlPrefilter(o) + l[2], u = l[0]; u--; ) s = s.lastChild;
                    w.merge(d, s.childNodes), ((s = f.firstChild).textContent = "");
                } else d.push(t.createTextNode(o));
        for (f.textContent = "", h = 0; (o = d[h++]); )
            if (r && w.inArray(o, r) > -1) i && i.push(o);
            else if (((c = ie(o)), (s = ve(f.appendChild(o), "script")), c && ye(s), n)) for (u = 0; (o = s[u++]); ) ge.test(o.type || "") && n.push(o);
        return f;
    }
    var we = /^([^.]*)(?:\.(.+)|)/;
    function xe() {
    ...
    (w.event = {
                ...
                for (
                    ...
                    (h = g = (a = we.exec(t[c]) || [])[1]),
                        ...
                        h &&
                            ...
                            (f = w.event.special[h] || {}),
                            (u = w.extend({ type: h, origType: g, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && w.expr.match.needsContext.test(i), namespace: p.join(".") }, o)),
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(P) || [""]).length; c--; )
                    if (((h = g = (a = we.exec(t[c]) || [])[1]), (p = (a[2] || "").split(".").sort()), h)) {
                        for (f = w.event.special[h] || {}, d = l[(h = (r ? f.delegateType : f.bindType) || h)] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--; )
                            (u = d[o]),
                                (!i && g !== u.origType) ||
                                    (n && n.guid !== u.guid) ||
                    ...
                    } else for (h in l) w.event.remove(e, h + t[c], n, r, !0);
        ...
        dispatch: function (e) {
            ...
            if (((l.delegateTarget = this), !u.preDispatch || !1 !== u.preDispatch.call(this, l))) {
                for (s = w.event.handlers.call(this, l, c), t = 0; (i = s[t++]) && !l.isPropagationStopped(); )
                    for (l.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !l.isImmediatePropagationStopped(); )
                        (l.rnamespace && !1 !== o.namespace && !l.rnamespace.test(o.namespace)) ||
                            ((l.handleObj = o), (l.data = o.data), void 0 !== (r = ((w.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a)) && !1 === (l.result = r) && (l.preventDefault(), l.stopPropagation()));
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && A(t, "input") && De(t, "click", xe), !1;
                },
                trigger: function (e) {
                    var t = this || e;
                ...
                _default: function (e) {
                    var t = e.target;
                    return (he.test(t.type) && t.click && A(t, "input") && Y.get(t, "click")) || A(t, "a");
                },
            },
            beforeunload: {
    ...
    function Oe(e, t) {
        var n, r, i, o, s, a;
        if (1 === t.nodeType) {
            if (Y.hasData(e) && (a = Y.get(e).events)) for (i in (Y.remove(t, "handle events"), a)) for (n = 0, r = a[i].length; n < r; n++) w.event.add(t, i, a[i][n]);
            Q.hasData(e) && ((o = Q.access(e)), (s = w.extend({}, o)), Q.set(t, s));
        }
    }
    function Ne(e, t) {
        var n = t.nodeName.toLowerCase();
    ...
    function Pe(e, t, n, r) {
        ...
        var i,
            ...
            m = t[0],
            v = p(m);
        if (v || (d > 1 && "string" == typeof m && !h.checkClone && Ee.test(m)))
            return e.each(function (i) {
                var o = e.eq(i);
                v && (t[0] = m.call(this, i, o.html())), Pe(o, t, n, r);
            });
        if (d && ((s = (i = _e(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === i.childNodes.length && (i = s), s || r)) {
            for (l = (a = w.map(ve(i, "script"), Ie)).length; f < d; f++) (c = i), f !== g && ((c = w.clone(c, !0, !0)), l && w.merge(a, ve(c, "script"))), n.call(e[f], c, f);
            if (l)
                for (u = a[a.length - 1].ownerDocument, w.map(a, je), f = 0; f < l; f++)
                    (c = a[f]),
                        ge.test(c.type || "") &&
                            !Y.access(c, "globalEval") &&
                            w.contains(u, c) &&
                            (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, { nonce: c.nonce || c.getAttribute("nonce") }, u) : y(c.textContent.replace(ke, ""), c, u));
        }
        return e;
    }
    function Fe(e, t, n) {
    ...
    w.extend({
        ...
        clone: function (e, t, n) {
            var r,
                ...
                a = e.cloneNode(!0),
                l = ie(e);
            if (!(h.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || w.isXMLDoc(e))) for (s = ve(a), r = 0, i = (o = ve(e)).length; r < i; r++) Ne(o[r], s[r]);
            if (t)
    ...
    function $e(e, t, n) {
        ...
        return (
            (n = n || Me(e)) &&
                ...
                !h.pixelBoxStyles() && Re.test(s) && We.test(t) && ((r = l.width), (i = l.minWidth), (o = l.maxWidth), (l.minWidth = l.maxWidth = l.width = s), (s = n.width), (l.width = r), (l.minWidth = i), (l.maxWidth = o))),
            void 0 !== s ? s + "" : s
        );
    }
    function ze(e, t) {
    ...
    function Ze(e, t, n, r, i, o) {
        ...
        for (; s < 4; s += 2)
            "margin" === n && (l += w.css(e, n + ne[s], !0, i)),
                r
                    ? ("content" === n && (l -= w.css(e, "padding" + ne[s], !0, i)), "margin" !== n && (l -= w.css(e, "border" + ne[s] + "Width", !0, i)))
                    : ((l += w.css(e, "padding" + ne[s], !0, i)), "padding" !== n ? (l += w.css(e, "border" + ne[s] + "Width", !0, i)) : (a += w.css(e, "border" + ne[s] + "Width", !0, i)));
    ...
    function et(e, t, n) {
        ...
        return (
            ((!h.boxSizingReliable() && i) || (!h.reliableTrDimensions() && A(e, "tr")) || "auto" === s || (!parseFloat(s) && "inline" === w.css(e, "display", !1, r))) &&
                e.getClientRects().length &&
                ((i = "border-box" === w.css(e, "boxSizing", !1, r)), (o = a in e) && (s = e[a])),
            (s = parseFloat(s) || 0) + Ze(e, t, n || (i ? "border" : "content"), o, r, s) + "px"
        );
    }
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i,
                    ...
                    l = He.test(t),
                    c = e.style;
                if ((l || (t = Je(a)), (s = w.cssHooks[t] || w.cssHooks[a]), void 0 === n)) return s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : c[t];
                "string" === (o = typeof n) && (i = te.exec(n)) && i[1] && ((n = ae(e, t, i)), (o = "number")),
                    null != n &&
                        n == n &&
                        ("number" !== o || l || (n += (i && i[3]) || (w.cssNumber[a] ? "" : "px")),
            ...
            w.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                    var i,
                        ...
                        l = r ? Ze(e, t, r, a, o) : 0;
                    return (
                        a && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Ze(e, t, "border", !1, o) - 0.5)),
    ...
    var nt,
        ...
        ot = /queueHooks$/;
    function st() {
        rt && (!1 === m.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(st) : e.setTimeout(st, w.fx.interval), w.fx.tick());
    }
    function at() {
        return (
            e.setTimeout(function () {
    ...
    function ut(e, t, n) {
        ...
        for (
            ...
            if ((r = ut.prefilters[o].call(c, e, u, c.opts))) return p(r.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)), r;
        return (
            w.map(u, ct, c),
    ...
    (w.Animation = w.extend(ut, {
            ...
            function (e, t, n) {
                ...
                if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(h))
                    for (r in (f &&
                        ...
                        "none" === (u = w.css(e, "display")) && (c ? (u = c) : (ue([e], !0), (c = e.style.display || c), (u = w.css(e, "display")), ue([e]))),
                    ...
                    h))
                        l ||
                            ...
                            g && ue([e], !0),
                            d.done(function () {
                                for (r in (g || ue([e]), Y.remove(e, "fxshow"), h)) w.style(e, r, h[r]);
                            })),
                            (l = ct(g ? m[r] : 0, r, d)),
        ...
        (w.speed = function (e, t, n) {
            var r = e && "object" == typeof e ? w.extend({}, e) : { complete: n || (!n && t) || (p(e) && e), duration: e, easing: (n && t) || (t && !p(t) && t) };
            return (
        ...
        w.fn.extend({
            addClass: function (e) {
                ...
                return p(e)
                    ...
                    : (t = vt(e)).length
                    ? this.each(function () {
                          if (((r = mt(this)), (n = 1 === this.nodeType && " " + gt(r) + " "))) {
            ...
            toggleClass: function (e, t) {
                ...
                return p(e)
                    ...
                    : ((n = vt(e)),
                      this.each(function () {
                          if (a) for (o = w(this), i = 0; i < n.length; i++) (r = n[i]), o.hasClass(r) ? o.removeClass(r) : o.addClass(r);
                          else (void 0 !== e && "boolean" !== s) || ((r = mt(this)) && Y.set(this, "__className__", r), this.setAttribute && this.setAttribute("class", r || !1 === e ? "" : Y.get(this, "__className__") || ""));
                      }));
            },
            hasClass: function (e) {
                var t,
    ...
    w.extend(w.event, {
        trigger: function (t, n, r, i) {
            ...
            if (
                ...
                if (!i && !d.noBubble && !g(r)) {
                    for (l = d.delegateType || y, bt.test(l + y) || (s = s.parentNode); s; s = s.parentNode) v.push(s), (a = s);
                ...
                for (o = 0; (s = v[o++]) && !t.isPropagationStopped(); )
                    (h = s),
                        ...
                        (f = c && s[c]) && f.apply && X(s) && ((t.result = f.apply(s, n)), !1 === t.result && t.preventDefault());
                return (
                    (t.type = y),
                    i ||
        ...
        w.fn.extend({
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    .filter(function () {
                        var e = this.type;
                        return this.name && !w(this).is(":disabled") && At.test(this.nodeName) && !Dt.test(e) && (this.checked || !he.test(e));
                    })
                    .map(function (e, t) {
                        var n = w(this).val();
                        return null == n
    ...
    (Ht.href = wt.href),
        w.extend({
            ...
            ajax: function (t, n) {
                ...
                var r,
                    ...
                    T = {
                        ...
                        getResponseHeader: function (e) {
                            var t;
                            if (c) {
                                if (!s) for (s = {}; (t = jt.exec(o)); ) s[t[1].toLowerCase() + " "] = (s[t[1].toLowerCase() + " "] || []).concat(t[2]);
                                t = s[e.toLowerCase() + " "];
                            }
                ...
                if (
                    (v.promise(T),
                    (h.url = ((t || h.url || wt.href) + "").replace(Nt, wt.protocol + "//")),
                ...
                if ((h.data && h.processData && "string" != typeof h.data && (h.data = w.param(h.data, h.traditional)), qt(Pt, h, n, T), c)) return T;
                for (f in ((u = w.event && h.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
                ...
                h.hasContent
                    ...
                    : ((d = h.url.slice(i.length)),
                      h.data && (h.processData || "string" == typeof h.data) && ((i += (St.test(i) ? "&" : "?") + h.data), delete h.data),
                      !1 === h.cache && ((i = i.replace(It, "$1")), (d = (St.test(i) ? "&" : "?") + "_=" + xt.guid++ + d)),
                      (h.url = i + d)),
                h.ifModified && (w.lastModified[i] && T.setRequestHeader("If-Modified-Since", w.lastModified[i]), w.etag[i] && T.setRequestHeader("If-None-Match", w.etag[i])),
                ...
                if (((S = "abort"), y.add(h.complete), T.done(h.success), T.fail(h.error), (r = qt(Ft, h, n, T)))) {
                ...
                function C(t, n, s, l) {
                    ...
                    c ||
                        ...
                        !f && w.inArray("script", h.dataTypes) > -1 && w.inArray("json", h.dataTypes) < 0 && (h.converters["text script"] = function () {}),
                        (_ = (function (e, t, n, r) {
                            var i,
                                o,
                                s,
                        ...
                        f
                            ? (h.ifModified && ((x = T.getResponseHeader("Last-Modified")) && (w.lastModified[i] = x), (x = T.getResponseHeader("etag")) && (w.etag[i] = x)),
                              204 === t || "HEAD" === h.type ? (S = "nocontent") : 304 === t ? (S = "notmodified") : ((S = _.state), (d = _.data), (f = !(m = _.error))))
                            : ((m = S), (!t && S) || ((S = "error"), t < 0 && (t = 0))),
                        (T.status = t),
                        (T.statusText = (n || S) + ""),
                        f ? v.resolveWith(p, [d, S, T]) : v.rejectWith(p, [T, S, m]),
                        T.statusCode(b),
                        (b = void 0),
                        u && g.trigger(f ? "ajaxSuccess" : "ajaxError", [T, h, f ? d : m]),
                        y.fireWith(p, [T, S]),
                        u && (g.trigger("ajaxComplete", [T, h]), --w.active || w.event.trigger("ajaxStop")));
                }
                return T;
            },
        ...
        w.ajaxPrefilter("json jsonp", function (t, n, r) {
            ...
            if (a || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    a ? (t[a] = t[a].replace(Vt, "$1" + i)) : !1 !== t.jsonp && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
                    ...
                    r.always(function () {
                        void 0 === o ? w(e).removeProp(i) : (e[i] = o), t[i] && ((t.jsonpCallback = n.jsonpCallback), Ut.push(i)), s && p(o) && o(s[0]), (s = o = void 0);
                    }),
                    "script"
                );
        }),
        (h.createHTMLDocument = (((zt = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === zt.childNodes.length)),
        (w.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ? []
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  t || (h.createHTMLDocument ? (((r = (t = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href), t.head.appendChild(r)) : (t = m)),
                  (o = !n && []),
                  (i = E.exec(e)) ? [t.createElement(i[1])] : ((i = _e([e], t, o)), o && o.length && w(o).remove(), w.merge([], i.childNodes)));
            var r, i, o;
        }),
    ...
    return (
        (w.noConflict = function (t) {
            return e.$ === w && (e.$ = Yt), t && e.jQuery === w && (e.jQuery = Jt), w;
        }),
    ...
    (function (e) {
        ...
        function o(e, t, n) {
            ...
            return !!w(e) || (t && r && (e = x(e, t)), n && r && (e = e.replace(_, "")), !isNaN(parseFloat(e)) && isFinite(e));
        }
        function s(e, t, n) {
            var r;
            return !!w(e) || ((w((r = e)) || "string" == typeof r) && !!o(e.replace(v, ""), t, n)) || null;
        }
        function a(e, t, n, i) {
            var o = [],
                s = 0,
                a = t.length;
            if (i !== r) for (; s < a; s++) e[t[s]][n] && o.push(e[t[s]][n][i]);
            else for (; s < a; s++) o.push(e[t[s]][n]);
            return o;
        }
        function l(e, t) {
            var n,
        ...
        var f,
            ...
            h,
            p = function (t, n) {
                if (this instanceof p) return e(t).DataTable(n);
                (n = t),
                    (this.$ = function (e, t) {
                    ...
                    (this.api = function (e) {
                        return new Ct(e ? st(this[f.iApiIndex]) : this);
                    }),
                    ...
                    (this.fnDeleteRow = function (e, t, n) {
                        var i = this.api(!0),
                            ...
                            s = o.aoData[e[0][0]];
                        return e.remove(), t && t.call(this, o, s), (n !== r && !n) || i.draw(), s;
                    }),
                    ...
                    (this.fnFilter = function (e, t, n, i, o, s) {
                        var a = this.api(!0);
                        (null === t || t === r ? a : a.column(t)).search(e, n, i, s), a.draw();
                    }),
                    ...
                    (this.fnUpdate = function (e, t, n, i, o) {
                        var s = this.api(!0);
                        return (n === r || null === n ? s.row(t) : s.cell(t, n)).data(e), (o !== r && !o) || s.columns.adjust(), (i !== r && !i) || s.draw(), 0;
                    }),
                ...
                var i,
                    ...
                    s = n === r,
                    a = this.length;
                for (i in (s && (n = {}), (this.oApi = this.internal = f.internal), p.ext.internal)) i && (this[i] = Ut(i));
                return (
                    this.each(function () {
                        var t = 1 < a ? ct({}, n, !0) : n,
                            i = 0,
                        ...
                        if ("table" != this.nodeName.toLowerCase()) at(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                            ...
                            L(u), I(u.column), A(u, u, !0), A(u.column, u.column, !0), A(u, e.extend(t, f.data()), !0);
                            for (var d = p.settings, h = ((i = 0), d.length); i < h; i++) {
                                var g = d[i];
                            ...
                            (null !== l && "" !== l) || ((l = "DataTables_Table_" + p.ext._unique++), (this.id = l));
                            var y,
                                b,
                                _ = e.extend(!0, {}, p.models.oSettings, { sDestroyWidth: f[0].style.width, sInstance: l, sTableId: l }),
                                w =
                                    ((_.nTable = this),
                                    (_.oApi = o.internal),
                                    (_.oInit = t),
                                    d.push(_),
                                    (_.oInstance = 1 === o.length ? o : f.dataTable()),
                                    L(t),
                                    E(t.oLanguage),
                                    ...
                                    ft(_, "aoDrawCallback", t.fnDrawCallback, "user"),
                                    ft(_, "aoServerParams", t.fnServerParams, "user"),
                                    ft(_, "aoStateSaveParams", t.fnStateSaveParams, "user"),
                                    ft(_, "aoStateLoadParams", t.fnStateLoadParams, "user"),
                                    ft(_, "aoStateLoaded", t.fnStateLoaded, "user"),
                                    ft(_, "aoRowCallback", t.fnRowCallback, "user"),
                                    ft(_, "aoRowCreatedCallback", t.fnCreatedRow, "user"),
                                    ft(_, "aoHeaderCallback", t.fnHeaderCallback, "user"),
                                    ft(_, "aoFooterCallback", t.fnFooterCallback, "user"),
                                    ft(_, "aoInitComplete", t.fnInitComplete, "user"),
                                    ft(_, "aoPreDrawCallback", t.fnPreDrawCallback, "user"),
                                    (_.rowIdFn = Q(t.rowId)),
                                    j(_),
                                    _.oClasses),
                                x =
                                    (e.extend(w, p.ext.classes, t.oClasses),
                                    f.addClass(w.sTable),
                                    _.iInitDisplayStart === r && ((_.iInitDisplayStart = t.iDisplayStart), (_._iDisplayStart = t.iDisplayStart)),
                                    null !== t.iDeferLoading &&
                                        ((_.bDeferLoading = !0), (l = Array.isArray(t.iDeferLoading)), (_._iRecordsDisplay = l ? t.iDeferLoading[0] : t.iDeferLoading), (_._iRecordsTotal = l ? t.iDeferLoading[1] : t.iDeferLoading)),
                                    _.oLanguage),
                                S =
                                    ((l =
                                        ...
                                        x.sUrl
                                            ? (e.ajax({
                                                  ...
                                                  url: x.sUrl,
                                                  success: function (t) {
                                                      A(u.oLanguage, t), E(t), e.extend(!0, x, t, _.oInit.oLanguage), dt(_, null, "i18n", [_]), je(_);
                                                  },
                                                  error: function () {
                                                      je(_);
                                                  },
                                ...
                                T =
                                    (-1 !==
                                        ...
                                        ) && (e("tbody tr", this).removeClass(l.join(" ")), (_.asDestroyStripes = l.slice())),
                                    []);
                            if ((0 !== (l = this.getElementsByTagName("thead")).length && (ue(_.aoHeader, l[0]), (T = fe(_))), null === t.aoColumns)) for (y = [], i = 0, h = T.length; i < h; i++) y.push(null);
                            else y = t.aoColumns;
                            for (i = 0, h = y.length; i < h; i++) N(_, T ? T[i] : null);
                            B(_, t.aoColumnDefs, y, function (e, t) {
                                P(_, e, t);
                            }),
                                S.length &&
                                    ((b = function (e, t) {
                                        ...
                                        .each(function (e, t) {
                                            ...
                                            i || at(_, 0, "Incorrect column count", 18),
                                                i.mData === e &&
                                                    ...
                                                    (null === n && null === t) ||
                                                        ((i.mData = { _: e + ".display", sort: null !== n ? e + ".@data-" + n : r, type: null !== n ? e + ".@data-" + n : r, filter: null !== t ? e + ".@data-" + t : r }), P(_, e)));
                                        }));
                            var C = _.oFeatures;
                            l = function () {
                                if (t.aaSorting === r) {
                                    var n = _.aaSorting;
                                    for (i = 0, h = n.length; i < h; i++) n[i][1] = _.aoColumns[i].asSorting[0];
                                }
                                tt(_),
                                    C.bSort &&
                                        ft(_, "aoDrawCallback", function () {
                                            var t, n;
                                            _.bSorted &&
                                                ((t = Qe(_)),
                                                (n = {}),
                                ...
                                var o,
                                    s = f.children("caption").each(function () {
                                        this._captionSide = e(this).css("caption-side");
                                    }),
                                    a = (0 === (o = f.children("thead")).length && (o = e("<thead/>").appendTo(f)), (_.nTHead = o[0]), f.children("tbody"));
                                if (
                                    (0 ===
                                        (o =
                                            0 === (o = (0 === a.length && (a = e("<tbody/>").insertAfter(o)), (_.nTBody = a[0]), f.children("tfoot"))).length && 0 < s.length && ("" !== _.oScroll.sX || "" !== _.oScroll.sY)
                                                ? e("<tfoot/>").appendTo(f)
                                                : o).length || 0 === o.children().length
                                        ? f.addClass(w.sNoFooter)
                                        : 0 < o.length && ((_.nTFoot = o[0]), ue(_.aoFooter, _.nTFoot)),
                                    t.aaData)
                                )
                                    for (i = 0; i < t.aaData.length; i++) $(_, t.aaData[i]);
                                else (!_.bDeferLoading && "dom" != gt(_)) || z(_, e(_.nTBody).children("tr"));
                                (_.aiDisplay = _.aiDisplayMaster.slice()), !(_.bInitialised = !0) === c && je(_);
                            };
                            ft(_, "aoDrawCallback", rt, "state_save"), t.bStateSave ? ((C.bStateSave = !0), it(_, 0, l)) : l();
                        }
                    }),
                    (o = null),
                    this
            ...
            x = function (e, t) {
                return g[t] || (g[t] = new RegExp(Se(t), "g")), "string" == typeof e && "." !== t ? e.replace(/\./g, "").replace(g[t], ".") : e;
            },
            S = function (e, t, n) {
                var i = [],
                    o = 0,
                    s = e.length;
                if (n !== r) for (; o < s; o++) e[o] && e[o][t] && i.push(e[o][t][n]);
                else for (; o < s; o++) e[o] && i.push(e[o][t]);
                return i;
            },
            T = function (e) {
                if (
                ...
                var t,
                    ...
                    s = 0;
                e: for (n = 0; n < o; n++) {
                    for (t = e[n], r = 0; r < s; r++) if (i[r] === t) continue e;
                    i.push(t), s++;
                }
                return i;
            },
        ...
        function D(t) {
            ...
            e.each(t, function (e, o) {
                (n = e.match(/^([^A-Z]+?)([A-Z])/)) && -1 !== "a aa ai ao as b fn i m o s ".indexOf(n[1] + " ") && ((r = e.replace(n[0], n[2].toLowerCase())), (i[r] = e), "o" === n[1] && D(t[e]));
            }),
                (t._hungarianMap = i);
        }
        function A(t, n, i) {
            ...
            t._hungarianMap || D(t),
                e.each(n, function (s, a) {
                    (o = t._hungarianMap[s]) === r || (!i && n[o] !== r) || ("o" === o.charAt(0) ? (n[o] || (n[o] = {}), e.extend(!0, n[o], n[s]), A(t[o], n[o], i)) : (n[o] = n[s]));
                });
        }
        function E(e) {
            var t,
            ...
            (p.util = {
                ...
                set: function (t) {
                    ...
                    return e.isPlainObject(t)
                        ...
                        : ((n = function (e, t, i) {
                              for (var o, s, a, l, c = Y(i), u = ((i = c[c.length - 1]), 0), f = c.length - 1; u < f; u++) {
                                  if ("__proto__" === c[u] || "constructor" === c[u]) throw new Error("Cannot set prototype values");
                                  if (((o = c[u].match(X)), (s = c[u].match(J)), o)) {
                                      if (((c[u] = c[u].replace(X, "")), (e[c[u]] = []), (o = c.slice()).splice(0, u + 1), (l = o.join(".")), Array.isArray(t)))
                                          for (var d = 0, h = t.length; d < h; d++) n((a = {}), t[d], l), e[c[u]].push(a);
                                      else e[c[u]] = t;
                                      return;
                                  }
                                  s && ((c[u] = c[u].replace(J, "")), (e = e[c[u]](t))), (null !== e[c[u]] && e[c[u]] !== r) || (e[c[u]] = {}), (e = e[c[u]]);
                              }
                        ...
                        : ((i = function (e, t, n) {
                              ...
                              if ("" !== n)
                                  for (var l = Y(n), c = 0, u = l.length; c < u; c++) {
                                      if (((h = l[c].match(X)), (o = l[c].match(J)), h)) {
                                          if (((l[c] = l[c].replace(X, "")), "" !== l[c] && (e = e[l[c]]), (s = []), l.splice(0, c + 1), (a = l.join(".")), Array.isArray(e))) for (var f = 0, d = e.length; f < d; f++) s.push(i(e[f], t, a));
                                          var h = h[0].substring(1, h[0].length - 1);
                                          e = "" === h ? s : s.join(h);
                                          break;
                                      }
                                      if (o) (l[c] = l[c].replace(J, "")), (e = e[l[c]]());
                                      else {
        ...
        function L(e) {
            ...
            if (t) for (var n = 0, r = t.length; n < r; n++) t[n] && A(p.models.oSearch, t[n]);
        }
        function I(e) {
        ...
        function O(e, t, n, i, o, s) {
            var a,
                l = i,
                c = !1;
            for (n !== r && ((a = n), (c = !0)); l !== o; ) e.hasOwnProperty(l) && ((a = c ? t(a, e[l], l, e) : e[l]), (c = !0), (l += s));
            return a;
        }
        function N(t, r) {
            var i = p.defaults.column,
                o = t.aoColumns.length;
            i = e.extend({}, p.models.oColumn, i, { nTh: r || n.createElement("th"), sTitle: i.sTitle || (r ? r.innerHTML : ""), aDataSort: i.aDataSort || [o], mData: i.mData || o, idx: o });
            ((i = (t.aoColumns.push(i), t.aoPreSearchCols))[o] = e.extend({}, p.models.oSearch, i[o])), P(t, o, e(r).data());
        }
        function P(t, n, i) {
            function o(e) {
            ...
            var s = t.oClasses,
                a = e(n.nTh),
                l =
                    (n.sWidthOrig || ((n.sWidthOrig = a.attr("width") || null), (f = (a.attr("style") || "").match(/width:\s*(\d+[pxem%]+)/)) && (n.sWidthOrig = f[1])),
                    i !== r &&
                        null !== i &&
                        (I(i),
                ...
                f =
                    ...
                    t.oFeatures.bSort || ((n.bSortable = !1), a.addClass(s.sSortableNone)),
                    -1 !== e.inArray("asc", n.asSorting));
            i = -1 !== e.inArray("desc", n.asSorting);
            n.bSortable && (f || i)
                ? f && !i
                    ? ((n.sSortingClass = s.sSortableAsc), (n.sSortingClassJUI = s.sSortJUIAscAllowed))
                    : !f && i
                    ? ((n.sSortingClass = s.sSortableDesc), (n.sSortingClassJUI = s.sSortJUIDescAllowed))
                    : ((n.sSortingClass = s.sSortable), (n.sSortingClassJUI = s.sSortJUI))
        ...
        function H(t, n) {
            return (t = q(t, "bVisible")), -1 !== (n = e.inArray(n, t)) ? n : null;
        }
        function M(t) {
            var n = 0;
            return (
        ...
        function W(e) {
            for (var t, n, i, o, s, a, l, c = e.aoColumns, u = e.aoData, f = p.ext.type.detect, d = 0, h = c.length; d < h; d++)
                if (((l = []), !(s = c[d]).sType && s._sManualType)) s.sType = s._sManualType;
                else if (!s.sType) {
                    for (t = 0, n = f.length; t < n; t++) {
                        for (i = 0, o = u.length; i < o && (l[i] === r && (l[i] = U(e, i, d, "type")), (a = f[t](l[i], e)) || t === f.length - 1) && ("html" !== a || w(l[i])); i++);
                        if (a) {
                            s.sType = a;
                            break;
                        }
        ...
        function B(t, n, i, o) {
            ...
            if (n)
                for (s = n.length - 1; 0 <= s; s--)
                    for (var f, d = (f = n[s]).target !== r ? f.target : f.targets !== r ? f.targets : f.aTargets, h = 0, p = (d = Array.isArray(d) ? d : [d]).length; h < p; h++)
                        if ("number" == typeof d[h] && 0 <= d[h]) {
                            for (; u.length <= d[h]; ) N(t);
                            o(d[h], f);
                        } else if ("number" == typeof d[h] && d[h] < 0) o(u.length + d[h], f);
                        else if ("string" == typeof d[h]) for (l = 0, c = u.length; l < c; l++) ("_all" != d[h] && !e(u[l].nTh).hasClass(d[h])) || o(l, f);
            if (i) for (s = 0, a = i.length; s < a; s++) o(s, i[s]);
        }
        function $(t, n, i, o) {
            for (var s = t.aoData.length, a = e.extend(!0, {}, p.models.oRow, { src: i ? "dom" : "data", idx: s }), l = ((a._aData = n), t.aoData.push(a), t.aoColumns), c = 0, u = l.length; c < u; c++) l[c].sType = null;
            return t.aiDisplayMaster.push(s), (n = t.rowIdFn(n)) !== r && (t.aIds[n] = a), (!i && t.oFeatures.bDeferRender) || re(t, s, i, o), s;
        }
        function z(t, n) {
            var r;
            return (n = n instanceof e ? n : e(n)).map(function (e, n) {
                return (r = ne(t, n)), $(t, r.data, n, r.cells);
            });
        }
        function U(e, t, n, i) {
            ...
            var o = e.iDraw,
                ...
                a = e.aoData[t]._aData,
                l = s.sDefaultContent,
                c = s.fnGetData(a, i, { settings: e, row: t, col: n });
            if (c === r)
                return e.iDrawError != o && null === l && (at(e, 0, "Requested unknown parameter " + ("function" == typeof s.mData ? "{function}" : "'" + s.mData + "'") + " for row " + t + ", column " + n, 4), (e.iDrawError = o)), l;
        ...
        function V(e, t, n, r) {
            var i = e.aoColumns[n],
                o = e.aoData[t]._aData;
            i.fnSetData(o, r, { settings: e, row: t, col: n });
        }
        var X = /\[.*?\]$/,
            J = /\(\)$/;
        function Y(t) {
        ...
        function ee(e, t, n) {
            for (var i = -1, o = 0, s = e.length; o < s; o++) e[o] == t ? (i = o) : e[o] > t && e[o]--;
        ...
        function ne(e, t, n, i) {
            function o(e, t) {
                var n;
                "string" == typeof e && -1 !== (n = e.indexOf("@")) && ((n = e.substring(n + 1)), G(e)(i, t.getAttribute(n)));
            }
            function s(e) {
                (n !== r && n !== d) ||
                    ((l = h[d]), (c = e.innerHTML.trim()), l && l._bAttrSrc ? (G(l.mData._)(i, c), o(l.mData.sort, e), o(l.mData.type, e), o(l.mData.filter, e)) : p ? (l._setter || (l._setter = G(l.mData)), l._setter(i, c)) : (i[d] = c)),
                    d++;
            }
            var a,
                l,
                ...
                h = e.aoColumns,
                p = e._rowReadObject;
            if (((i = i !== r ? i : p ? {} : []), f)) for (; f; ) ("TD" != (a = f.nodeName.toUpperCase()) && "TH" != a) || (s(f), u.push(f)), (f = f.nextSibling);
            else for (var g = 0, m = (u = t.anCells).length; g < m; g++) s(u[g]);
            return (t = t.firstChild ? t : t.nTr) && (t = t.getAttribute("id")) && G(e.rowId)(i, t), { data: i, cells: u };
        }
        function re(t, r, i, o) {
            var s,
                a,
                ...
                p = [];
            if (null === d.nTr) {
                for (s = i || n.createElement("tr"), d.nTr = s, d.anCells = p, s._DT_RowIndex = r, ie(t, d), c = 0, u = t.aoColumns.length; c < u; c++)
                    (l = t.aoColumns[c]),
                        (a = (f = !i) ? n.createElement(l.sCellType) : o[c]) || at(t, 0, "Incorrect column count", 18),
                        (a._DT_CellIndex = { row: r, column: c }),
                        p.push(a),
                        (!f && ((!l.mRender && l.mData === c) || (e.isPlainObject(l.mData) && l.mData._ === c + ".display"))) || (a.innerHTML = U(t, r, c, "display")),
                ...
                dt(t, "aoRowCreatedCallback", null, [s, h, r, p]);
            }
        }
        function ie(t, n) {
            var r = n.nTr,
                i = n._aData;
            r &&
                ((t = t.rowIdFn(i)) && (r.id = t),
                i.DT_RowClass && ((t = i.DT_RowClass.split(" ")), (n.__rowc = n.__rowc ? T(n.__rowc.concat(t)) : t), e(r).removeClass(n.__rowc.join(" ")).addClass(i.DT_RowClass)),
        ...
        function oe(t) {
            var n,
                ...
                o = t.nTHead,
                s = t.nTFoot,
                a = 0 === e("th, td", o).length,
                l = t.oClasses,
                c = t.aoColumns;
            for (a && (r = e("<tr/>").appendTo(o)), f = 0, d = c.length; f < d; f++)
                (i = c[f]),
                    (n = e(i.nTh).addClass(i.sClass)),
                    a && n.appendTo(r),
                    t.oFeatures.bSort && (n.addClass(i.sSortingClass), !1 !== i.bSortable && (n.attr("tabindex", t.iTabIndex).attr("aria-controls", t.sTableId), et(t, i.nTh, f))),
                    i.sTitle != n[0].innerHTML && n.html(i.sTitle),
                    pt(t, "header")(t, n, i, l);
            if ((a && ue(t.aoHeader, o), e(o).children("tr").children("th, td").addClass(l.sHeaderTH), e(s).children("tr").children("th, td").addClass(l.sFooterTH), null !== s))
                for (var u = t.aoFooter[0], f = 0, d = u.length; f < d; f++) (i = c[f]) ? ((i.nTf = u[f].cell), i.sClass && e(i.nTf).addClass(i.sClass)) : at(t, 0, "Incorrect column count", 18);
        }
        function se(t, n, i) {
            var o,
                s,
            ...
            if (n) {
                for (i === r && (i = !1), o = 0, s = n.length; o < s; o++) {
                    for (p[o] = n[o].slice(), p[o].nTr = n[o].nTr, a = m - 1; 0 <= a; a--) t.aoColumns[a].bVisible || i || p[o].splice(a, 1);
                    g.push([]);
                }
                for (o = 0, s = p.length; o < s; o++) {
                    if ((f = p[o].nTr)) for (; (u = f.firstChild); ) f.removeChild(u);
                    for (a = 0, l = p[o].length; a < l; a++)
                        if (((h = d = 1), g[o][a] === r)) {
                            for (f.appendChild(p[o][a].cell), g[o][a] = 1; p[o + d] !== r && p[o][a].cell == p[o + d][a].cell; ) (g[o + d][a] = 1), d++;
                            for (; p[o][a + h] !== r && p[o][a].cell == p[o][a + h].cell; ) {
                                for (c = 0; c < d; c++) g[o + c][a + h] = 1;
                                h++;
                            }
                            e(p[o][a].cell).attr("rowspan", d).attr("colspan", h);
                        }
                }
            }
        }
        function ae(t, n) {
            (i = "ssp" == gt((u = t))), (c = u.iInitDisplayStart) !== r && -1 !== c && ((u._iDisplayStart = !i && c >= u.fnRecordsDisplay() ? 0 : c), (u.iInitDisplayStart = -1));
            var i = dt(t, "aoPreDrawCallback", "preDraw", [t]);
            if (-1 !== e.inArray(!1, i)) Me(t, !1);
            else {
                var o = [],
                    s = 0,
                    a = t.asStripeClasses,
                    ...
                    u = "ssp" == gt(t),
                    f = t.aiDisplay,
                    d = ((i = t._iDisplayStart), t.fnDisplayEnd());
                if (((t.bDrawing = !0), t.bDeferLoading)) (t.bDeferLoading = !1), t.iDraw++, Me(t, !1);
                else if (u) {
                    if (!t.bDestroying && !n) return void he(t);
                } else t.iDraw++;
                if (0 !== f.length)
                    for (var h = u ? t.aoData.length : d, p = u ? 0 : i; p < h; p++) {
                        var g,
                            m = f[p],
                            v = t.aoData[m],
                            y = (null === v.nTr && re(t, m), v.nTr);
                        0 !== l && ((g = a[s % l]), v._sRowStripe != g && (e(y).removeClass(v._sRowStripe).addClass(g), (v._sRowStripe = g))), dt(t, "aoRowCallback", null, [y, v._aData, s, p, m]), o.push(y), s++;
                    }
                else
                    (n = c.sZeroRecords),
                        1 == t.iDraw && "ajax" == gt(t) ? (n = c.sLoadingRecords) : c.sEmptyTable && 0 === t.fnRecordsTotal() && (n = c.sEmptyTable),
                        (o[0] = e("<tr/>", { class: l ? a[0] : "" }).append(e("<td />", { valign: "top", colSpan: M(t), class: t.oClasses.sRowEmpty }).html(n))[0]);
                dt(t, "aoHeaderCallback", "header", [e(t.nTHead).children("tr")[0], K(t), i, d, f]),
                    dt(t, "aoFooterCallback", "footer", [e(t.nTFoot).children("tr")[0], K(t), i, d, f]),
        ...
        function le(e, t) {
            var n = (r = e.oFeatures).bSort,
                r = r.bFilter;
            n && Ge(e), r ? ye(e, e.oPreviousSearch) : (e.aiDisplay = e.aiDisplayMaster.slice()), !0 !== t && (e._iDisplayStart = 0), (e._drawHold = t), ae(e), (e._drawHold = !1);
        }
        function ce(t) {
            for (
                var n,
                    ...
                    c = t.oClasses,
                    u = e(t.nTable),
                    f = ((u = e("<div/>").insertBefore(u)), t.oFeatures),
                    d = e("<div/>", { id: t.sTableId + "_wrapper", class: c.sWrapper + (t.nTFoot ? "" : " " + c.sNoFooter) }),
                    h = ((t.nHolding = u[0]), (t.nTableWrapper = d[0]), (t.nTableReinsertBefore = t.nTable.nextSibling), t.sDom.split("")),
                    g = 0;
                g < h.length;
                g++
            ) {
                if (((n = null), "<" == (r = h[g]))) {
                    if (((i = e("<div/>")[0]), "'" == (o = h[g + 1]) || '"' == o)) {
                        for (s = "", a = 2; h[g + a] != o; ) (s += h[g + a]), a++;
                        "H" == s ? (s = c.sJUIHeader) : "F" == s && (s = c.sJUIFooter),
                            -1 != s.indexOf(".") ? ((l = s.split(".")), (i.id = l[0].substr(1, l[0].length - 1)), (i.className = l[1])) : "#" == s.charAt(0) ? (i.id = s.substr(1, s.length - 1)) : (i.className = s),
                            (g += a);
                    }
                    d.append(i), (d = e(i));
                } else if (">" == r) d = d.parent();
                else if ("l" == r && f.bPaginate && f.bLengthChange) n = Pe(t);
                else if ("f" == r && f.bFilter) n = ve(t);
                else if ("r" == r && f.bProcessing) n = He(t);
                else if ("t" == r) n = qe(t);
                else if ("i" == r && f.bInfo) n = ke(t);
                else if ("p" == r && f.bPaginate) n = Fe(t);
                ...
                n && ((l = t.aanFeatures)[r] || (l[r] = []), l[r].push(n), d.append(n));
            }
            ...
            for (o = 0, l = h.length; o < l; o++)
                for (i = (r = h[o]).firstChild; i; ) {
                    if ("TD" == i.nodeName.toUpperCase() || "TH" == i.nodeName.toUpperCase())
                        for (
                            u = (u = +i.getAttribute("colspan")) && 0 !== u && 1 !== u ? u : 1,
                                f = (f = +i.getAttribute("rowspan")) && 0 !== f && 1 !== f ? f : 1,
                                c = (function (e, t, n) {
                                    for (var r = e[t]; r[n]; ) n++;
                                    return n;
                                })(t, o, 0),
                            ...
                            for (s = 0; s < f; s++) (t[o + s][c + a] = { cell: i, unique: d }), (t[o + s].nTr = r);
                    i = i.nextSibling;
                }
        }
        function fe(e, t, n) {
            ...
            for (var i = 0, o = n.length; i < o; i++) for (var s = 0, a = n[i].length; s < a; s++) !n[i][s].unique || (r[s] && e.bSortCellsTop) || (r[s] = n[i][s].cell);
            return r;
        }
        function de(t, n, r) {
            function i(e) {
                var n = t.jqXHR ? t.jqXHR.status : null;
                (null === e || ("number" == typeof n && 204 == n)) && me(t, (e = {}), []), (n = e.error || e.sError) && at(t, 0, n), (t.json = e), dt(t, null, "xhr", [t, e, t.jqXHR]), r(e);
            }
            dt(t, "aoServerParams", "serverParams", [n]),
                n &&
                    Array.isArray(n) &&
                    ((o = {}),
                    (s = /(.*?)\[\]$/),
                    e.each(n, function (e, t) {
                        ...
                        n ? ((n = n[0]), o[n] || (o[n] = []), o[n].push(t.value)) : (o[t.name] = t.value);
                    }),
                    (n = o));
            var o,
                s,
                ...
                c = t.oInstance,
                u =
                    (e.isPlainObject(l) && l.data && ((u = "function" == typeof (a = l.data) ? a(n, t) : a), (n = "function" == typeof a && u ? u : e.extend(!0, n, u)), delete l.data),
                    {
                        data: n,
                        success: i,
                        dataType: "json",
                        ...
                        error: function (n, r, i) {
                            var o = dt(t, null, "xhr", [t, null, t.jqXHR]);
                            -1 === e.inArray(!0, o) && ("parsererror" == r ? at(t, 0, "Invalid JSON response", 1) : 4 === n.readyState && at(t, 0, "Ajax error", 7)), Me(t, !1);
                        },
                    });
            (t.oAjaxData = n),
                ...
                t.fnServerData
                    ...
                    ? (t.jqXHR = e.ajax(e.extend(u, { url: l || t.sAjaxSource })))
                    : "function" == typeof l
                    ? (t.jqXHR = l.call(c, n, i, t))
                    : ((t.jqXHR = e.ajax(e.extend(u, l))), (l.data = a));
        }
        function he(e) {
            e.iDraw++,
                Me(e, !0),
                de(e, pe(e), function (t) {
                    ge(e, t);
                });
        }
        function pe(t) {
            for (
                var n,
                    ...
                    f = Qe(t),
                    d = t._iDisplayStart,
                    h = !1 !== a.bPaginate ? t._iDisplayLength : -1,
                    g = function (e, t) {
                    ...
                    m =
                        ...
                        g("iDisplayStart", d),
                        g("iDisplayLength", h),
                        { draw: t.iDraw, columns: [], order: [], start: d, length: h, search: { value: l.sSearch, regex: l.bRegex } }),
                    v = 0;
                v < s;
                v++
            )
                (r = o[v]),
                    ...
                    m.columns.push({ data: n, name: r.sName, searchable: r.bSearchable, orderable: r.bSortable, search: { value: i.sSearch, regex: i.bRegex } }),
                    g("mDataProp_" + v, n),
                    a.bFilter && (g("sSearch_" + v, i.sSearch), g("bRegex_" + v, i.bRegex), g("bSearchable_" + v, r.bSearchable)),
                    a.bSort && g("bSortable_" + v, r.bSortable);
            return (
                a.bFilter && (g("sSearch", l.sSearch), g("bRegex", l.bRegex)),
                a.bSort &&
                    (e.each(f, function (e, t) {
                        m.order.push({ column: t.col, dir: t.dir }), g("iSortCol_" + e, t.col), g("sSortDir_" + e, t.dir);
                    }),
                    g("iSortingCols", f.length)),
                null === (d = p.ext.legacy.ajax) ? (t.sAjaxSource ? u : m) : d ? u : m
            );
        }
        function ge(e, t) {
            function n(e, n) {
            ...
            (i = i || []), Z(e), (e._iRecordsTotal = parseInt(s, 10)), (e._iRecordsDisplay = parseInt(a, 10));
            for (var l = 0, c = i.length; l < c; l++) $(e, i[l]);
            (e.aiDisplay = e.aiDisplayMaster.slice()), ae(e, !0), e._bInitComplete || Oe(e, t), Me(e, !1);
        }
        function me(t, n, i) {
            if (((t = e.isPlainObject(t.ajax) && t.ajax.dataSrc !== r ? t.ajax.dataSrc : t.sAjaxDataProp), !i)) return "data" === t ? n.aaData || n[t] : "" !== t ? Q(t)(n) : n;
            G(t)(n, i);
        }
        function ve(t) {
            function r(e) {
                l.f;
                var n = this.value || "";
                (a.return && "Enter" !== e.key) || (n != a.sSearch && (ye(t, { sSearch: n, bRegex: a.bRegex, bSmart: a.bSmart, bCaseInsensitive: a.bCaseInsensitive, return: a.return }), (t._iDisplayStart = 0), ae(t)));
            }
            var i = t.oClasses,
                o = t.sTableId,
                s = t.oLanguage,
                ...
                f =
                    ((c = e("<div/>", { id: l.f ? null : o + "_filter", class: i.sFilter }).append(e("<label/>").append(u))),
                    (i = null !== t.searchDelay ? t.searchDelay : "ssp" === gt(t) ? 400 : 0),
                    e("input", c)
                        .val(a.sSearch)
                        .attr("placeholder", s.sSearchPlaceholder)
                        .on("keyup.DT search.DT input.DT paste.DT cut.DT", i ? Ue(r, i) : r)
        ...
        function ye(e, t, n) {
            function i(e) {
                (s.sSearch = e.sSearch), (s.bRegex = e.bRegex), (s.bSmart = e.bSmart), (s.bCaseInsensitive = e.bCaseInsensitive), (s.return = e.return);
            }
            function o(e) {
            ...
            var s = e.oPreviousSearch,
                a = e.aoPreSearchCols;
            if ((W(e), "ssp" != gt(e))) {
                we(e, t.sSearch, n, o(t), t.bSmart, t.bCaseInsensitive, t.return), i(t);
                for (var l = 0; l < a.length; l++) _e(e, a[l].sSearch, l, o(a[l]), a[l].bSmart, a[l].bCaseInsensitive);
                be(e);
            } else i(t);
        ...
        function be(t) {
            for (var n, r, i = p.ext.search, o = t.aiDisplay, s = 0, a = i.length; s < a; s++) {
                for (var l = [], c = 0, u = o.length; c < u; c++) (r = o[c]), (n = t.aoData[r]), i[s](t, n._aFilterData, r, n._aData, c) && l.push(r);
                (o.length = 0), e.merge(o, l);
            }
        }
        function _e(e, t, n, r, i, o) {
            if ("" !== t) {
                for (var s, a = [], l = e.aiDisplay, c = xe(t, r, i, o), u = 0; u < l.length; u++) (s = e.aoData[l[u]]._aFilterData[n]), c.test(s) && a.push(l[u]);
                e.aiDisplay = a;
            }
        }
        function we(e, t, n, r, i, o) {
            var s,
                ...
                l,
                c = xe(t, r, i, o),
                u = ((i = e.oPreviousSearch.sSearch), (o = e.aiDisplayMaster), []);
            if ((0 !== p.ext.search.length && (n = !0), (a = De(e)), t.length <= 0)) e.aiDisplay = o.slice();
            else {
                for ((a || n || r || i.length > t.length || 0 !== t.indexOf(i) || e.bSorted) && (e.aiDisplay = o.slice()), s = e.aiDisplay, l = 0; l < s.length; l++) c.test(e.aoData[s[l]]._sFilterRow) && u.push(s[l]);
                e.aiDisplay = u;
            }
        }
        function xe(t, n, r, i) {
        ...
        function De(e) {
            for (var t, n, r, i, o, s = e.aoColumns, a = !1, l = 0, c = e.aoData.length; l < c; l++)
                if (!(o = e.aoData[l])._aFilterData) {
                    for (r = [], t = 0, n = s.length; t < n; t++)
                        s[t].bSearchable ? "string" != typeof (i = null === (i = U(e, l, t, "filter")) ? "" : i) && i.toString && (i = i.toString()) : (i = ""),
                            i.indexOf && -1 !== i.indexOf("&") && ((Te.innerHTML = i), (i = Ce ? Te.textContent : Te.innerText)),
                            i.replace && (i = i.replace(/[\r\n\u2028]/g, "")),
                            r.push(i);
                    (o._aFilterData = r), (o._sFilterRow = r.join("  ")), (a = !0);
                }
            return a;
        }
        function Ae(e) {
        ...
        function ke(t) {
            var n = t.sTableId,
                r = t.aanFeatures.i,
                i = e("<div/>", { class: t.oClasses.sInfo, id: r ? null : n + "_info" });
            return r || (t.aoDrawCallback.push({ fn: Le, sName: "information" }), i.attr("role", "status").attr("aria-live", "polite"), e(t.nTable).attr("aria-describedby", n + "_info")), i[0];
        }
        function Le(t) {
            var n,
                r,
        ...
        function Ie(e, t) {
            ...
            return t
                ...
                .replace(/_PAGE_/g, n.call(e, s ? 1 : Math.ceil(r / i)))
                .replace(/_PAGES_/g, n.call(e, s ? 1 : Math.ceil(o / i)));
        }
        function je(e) {
            var t,
                n,
                r,
                i = e.iInitDisplayStart,
                o = e.aoColumns,
                s = e.oFeatures,
                a = e.bDeferLoading;
            if (e.bInitialised) {
                for (ce(e), oe(e), se(e, e.aoHeader), se(e, e.aoFooter), Me(e, !0), s.bAutoWidth && ze(e), t = 0, n = o.length; t < n; t++) (r = o[t]).sWidth && (r.nTh.style.width = Ye(r.sWidth));
                dt(e, null, "preInit", [e]),
                    le(e),
                    ("ssp" == (s = gt(e)) && !a) ||
                        ("ajax" == s
                            ? de(e, [], function (n) {
                                  ...
                                  (e.iInitDisplayStart = i), le(e), Me(e, !1), Oe(e, n);
                              })
                            : (Me(e, !1), Oe(e)));
            } else
                setTimeout(function () {
        ...
        function Ne(e, t) {
            (t = parseInt(t, 10)), (e._iDisplayLength = t), ht(e), dt(e, null, "length", [e, t]);
        }
        function Pe(t) {
            for (
                var n = t.oClasses,
                    ...
                    s = o ? i[0] : i,
                    a = o ? i[1] : i,
                    l = e("<select/>", { name: r + "_length", "aria-controls": r, class: n.sLengthSelect }),
                    c = 0,
                    u = s.length;
                c < u;
                c++
            ...
            return (
                ...
                f.children().append(t.oLanguage.sLengthMenu.replace("_MENU_", l[0].outerHTML)),
                e("select", f)
                    .val(t._iDisplayLength)
                    .on("change.DT", function (n) {
                        Ne(t, e(this).val()), ae(t);
                    }),
        ...
        function Fe(t) {
            ...
            var r = t.sPaginationType,
                i = p.ext.pager[r],
                o = "function" == typeof i,
                s = ((r = e("<div/>").addClass(t.oClasses.sPaging + r)[0]), t.aanFeatures);
            return (
                o || i.fnInit(t, r, n),
                s.p ||
                    ((r.id = t.sTableId + "_paginate"),
                    t.aoDrawCallback.push({
                        fn: function (e) {
                            if (o)
                                for (var t = e._iDisplayStart, r = e._iDisplayLength, a = e.fnRecordsDisplay(), l = -1 === r, c = l ? 0 : Math.ceil(t / r), u = l ? 1 : Math.ceil(a / r), f = i(c, u), d = 0, h = s.p.length; d < h; d++)
                                    pt(e, "pageButton")(e, s.p[d], d, f, c, u);
                            else i.fnUpdate(e, n);
                        },
                        sName: "pagination",
                    })),
            ...
            var r = e._iDisplayStart,
                ...
                o =
                    (0 === (o = e.fnRecordsDisplay()) || -1 === i
                        ...
                        ? r + i < o && (r += i)
                        : "last" == t
                        ? (r = Math.floor((o - 1) / i) * i)
                        : at(e, 0, "Unknown paging action: " + t, 5),
                    e._iDisplayStart !== r);
            return (e._iDisplayStart = r), o ? (dt(e, null, "page", [e]), n && ae(e)) : dt(e, null, "page-nc", [e]), o;
        }
        function He(t) {
            return e("<div/>", { id: t.aanFeatures.r ? null : t.sTableId + "_processing", class: t.oClasses.sProcessing })
        ...
        function qe(t) {
            ...
            return "" === g.sX && "" === g.sY
                ...
                : ((n = g.sX),
                  ...
                  (c = e((d = "<div/>"), { class: i.sScrollWrapper })
                      .append(
                          e(d, { class: i.sScrollHead })
                              .css({ overflow: "hidden", position: "relative", border: 0, width: n ? u(n) : "100%" })
                              .append(
                      ...
                      .append(
                          e(d, { class: i.sScrollBody })
                              .css({ position: "relative", overflow: "auto", width: u(n) })
                              .append(p)
                      )),
                  l &&
                      c.append(
                          e(d, { class: i.sScrollFoot })
                              .css({ overflow: "hidden", border: 0, width: n ? u(n) : "100%" })
                              .append(
                  ...
                  (h = l ? u[2] : null),
                  n &&
                      e(d).on("scroll.DT", function (e) {
                          var t = this.scrollLeft;
                          (f.scrollLeft = t), l && (h.scrollLeft = t);
                      }),
                  e(d).css("max-height", r),
                  g.bCollapse || e(d).css("height", r),
                  (t.nScrollHead = f),
                  (t.nScrollBody = d),
                  (t.nScrollFoot = h),
                  t.aoDrawCallback.push({ fn: We, sName: "scrolling" }),
                  c[0]);
        }
        function We(n) {
            function i(e) {
            ...
            n.scrollBarVis !== P && n.scrollBarVis !== r
                ? ((n.scrollBarVis = P), F(n))
                : ((n.scrollBarVis = P),
                  C.children("thead, tfoot").remove(),
                  E && ((P = E.clone().prependTo(C)), (c = E.find("tr")), (s = P.find("tr")), P.find("[id]").removeAttr("id")),
                  (P = T.clone().prependTo(C)),
                  (T = T.find("tr")),
                  (o = P.find("tr")),
                  P.find("th, td").removeAttr("tabindex"),
                  P.find("[id]").removeAttr("id"),
                  u || ((_.width = "100%"), (p[0].style.width = "100%")),
                  e.each(fe(n, P), function (e, t) {
                      (a = R(n, e)), (t.style.width = n.aoColumns[a].sWidth);
                  }),
                  E &&
                      Be(function (e) {
                          e.style.width = "";
                  ...
                  (p = C.outerWidth()),
                  "" === u
                      ? ((A.width = "100%"), L && (C.find("tbody").height() > y.offsetHeight || "scroll" == b.css("overflow-y")) && (A.width = Ye(C.outerWidth() - h)), (p = C.outerWidth()))
                      : "" !== f && ((A.width = Ye(f)), (p = C.outerWidth())),
                  Be(i, o),
                  Be(function (n) {
                      var r = t.getComputedStyle ? t.getComputedStyle(n).width : Ye(e(n).width());
                      O.push(n.innerHTML), I.push(r);
                  }, o),
                  Be(function (e, t) {
                      e.style.width = I[t];
                  }, T),
                  ...
                  E &&
                      (Be(i, s),
                      Be(function (t) {
                          N.push(t.innerHTML), j.push(Ye(e(t).css("width")));
                      }, s),
                      Be(function (e, t) {
                          e.style.width = j[t];
                      }, c),
                  ...
                  E &&
                      Be(function (e, t) {
                          (e.innerHTML = '<div class="dataTables_sizing">' + N[t] + "</div>"), (e.childNodes[0].style.height = "0"), (e.childNodes[0].style.overflow = "hidden"), (e.style.width = j[t]);
                      }, s),
                  Math.round(C.outerWidth()) < Math.round(p)
                      ? ((l = y.scrollHeight > y.offsetHeight || "scroll" == b.css("overflow-y") ? p + h : p),
                        L && (y.scrollHeight > y.offsetHeight || "scroll" == b.css("overflow-y")) && (A.width = Ye(l - h)),
                        ("" !== u && "" === f) || at(n, 1, "Possible column misalignment", 6))
                      : (l = "100%"),
                  (_.width = Ye(l)),
                  (g.width = Ye(l)),
                  E && (n.nScrollFoot.style.width = Ye(l)),
                  d || (L && (_.height = Ye(D.offsetHeight + h))),
                  (P = C.outerWidth()),
                  (v[0].style.width = Ye(P)),
                  (m.width = Ye(P)),
                  (T = C.height() > y.clientHeight || "scroll" == b.css("overflow-y")),
                  (m[(c = "padding" + (k.bScrollbarLeft ? "Left" : "Right"))] = T ? h + "px" : "0px"),
                  E && ((x[0].style.width = Ye(P)), (w[0].style.width = Ye(P)), (w[0].style[c] = T ? h + "px" : "0px")),
        ...
        function Be(e, t, n) {
            for (var r, i, o = 0, s = 0, a = t.length; s < a; ) {
                for (r = t[s].firstChild, i = n ? n[s].firstChild : null; r; ) 1 === r.nodeType && (n ? e(r, i, o) : e(r, o), o++), (r = r.nextSibling), (i = n ? i.nextSibling : null);
                s++;
            }
        }
        var $e = /<.*?>/g;
        function ze(n) {
            var r,
                ...
                m = n.oBrowser,
                v = m.bScrollOversize;
            for ((b = o.style.width) && -1 !== b.indexOf("%") && (h = b), S = 0; S < f.length; S++) null !== (r = s[f[S]]).sWidth && ((r.sWidth = Ve(r.sWidthOrig, p)), (g = !0));
            if (v || (!g && !l && !a && u == M(n) && u == d.length))
                for (S = 0; S < u; S++) {
                    var y = R(n, S);
                    null !== y && (s[y].sWidth = Ye(d.eq(S).width()));
                }
            else {
                var b,
                    _ = ((b = e(o).clone().css("visibility", "hidden").removeAttr("id")).find("tbody tr").remove(), e("<tr/>").appendTo(b.find("tbody")));
                for (b.find("thead, tfoot").remove(), b.append(e(n.nTHead).clone()).append(e(n.nTFoot).clone()), b.find("tfoot th, tfoot td").css("width", ""), d = fe(n, b.find("thead")[0]), S = 0; S < f.length; S++)
                    (r = s[f[S]]),
                        (d[S].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig ? Ye(r.sWidthOrig) : ""),
                        r.sWidthOrig && l && e(d[S]).append(e("<div/>").css({ width: r.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
                if (n.aoData.length) for (S = 0; S < f.length; S++) (r = s[(i = f[S])]), e(Xe(n, i)).clone(!1).append(r.sContentPadding).appendTo(_);
                e("[name]", b).removeAttr("name");
                for (
                    var w = e("<div/>")
                            .css(l || a ? { position: "absolute", top: 0, left: 0, height: 1, right: 0, overflow: "hidden" } : {})
                            .append(b)
                            .appendTo(p),
                        x = (l && c ? b.width(c) : l ? (b.css("width", "auto"), b.removeAttr("width"), b.width() < p.clientWidth && h && b.width(p.clientWidth)) : a ? b.width(p.clientWidth) : h && b.width(h), 0),
                        S = 0;
                    S < f.length;
                    S++
                ) {
                    var T,
                        C = (T = e(d[S])).outerWidth() - T.width();
                    (x += T = m.bBounding ? Math.ceil(d[S].getBoundingClientRect().width) : T.outerWidth()), (s[f[S]].sWidth = Ye(T - C));
                }
                (o.style.width = Ye(x)), w.remove();
            }
        ...
        function Ve(t, r) {
            return t
                ? ((r = (t = e("<div/>")
                      .css("width", Ye(t))
                      .appendTo(r || n.body))[0].offsetWidth),
                  t.remove(),
                  r)
                : 0;
        }
        ...
        function Je(e, t) {
            for (var n, r = -1, i = -1, o = 0, s = e.aoData.length; o < s; o++) (n = (n = (n = U(e, o, t, "display") + "").replace($e, "")).replace(/&nbsp;/g, " ")).length > r && ((r = n.length), (i = o));
            return i;
        }
        function Ye(e) {
        ...
        function Qe(t) {
            ...
            var i,
                ...
                g = e.isPlainObject(h),
                m = [];
            for (Array.isArray(h) && n(h), g && h.pre && n(h.pre), n(t.aaSorting), g && h.post && n(h.post), i = 0; i < m.length; i++)
                for (s = (a = d[(u = m[i][(o = 0)])].aDataSort).length; o < s; o++)
                    (c = d[(l = a[o])].sType || "string"), m[i]._idx === r && (m[i]._idx = e.inArray(m[i][1], d[l].asSorting)), f.push({ src: u, col: l, dir: m[i][1], index: m[i]._idx, type: c, formatter: p.ext.type.order[c + "-pre"] });
            return f;
        }
        function Ge(e) {
            var t,
                ...
                c = (e.aoColumns, 0),
                u = e.aiDisplayMaster;
            for (W(e), t = 0, n = (o = Qe(e)).length; t < n; t++) (i = o[t]).formatter && c++, nt(e, i.col);
            if ("ssp" != gt(e) && 0 !== o.length) {
                for (t = 0, r = u.length; t < r; t++) s[u[t]] = t;
                c === o.length
                    ? u.sort(function (e, t) {
                          for (var n, r, i, a, c = o.length, u = l[e]._aSortData, f = l[t]._aSortData, d = 0; d < c; d++) if (0 != (i = (n = u[(a = o[d]).col]) < (r = f[a.col]) ? -1 : r < n ? 1 : 0)) return "asc" === a.dir ? i : -i;
                          return (n = s[e]) < (r = s[t]) ? -1 : r < n ? 1 : 0;
                      })
                    : u.sort(function (e, t) {
                          for (var n, r, i, c = o.length, u = l[e]._aSortData, f = l[t]._aSortData, d = 0; d < c; d++)
                              if (((n = u[(i = o[d]).col]), (r = f[i.col]), 0 !== (i = (a[i.type + "-" + i.dir] || a["string-" + i.dir])(n, r)))) return i;
                          return (n = s[e]) < (r = s[t]) ? -1 : r < n ? 1 : 0;
                      });
            }
            e.bSorted = !0;
        ...
        function Ke(e) {
            for (var t = e.aoColumns, n = Qe(e), r = e.oLanguage.oAria, i = 0, o = t.length; i < o; i++) {
                ...
                c.removeAttribute("aria-sort"),
                    (s = s.bSortable
                        ? l + ("asc" === ((0 < n.length && n[0].col == i && (c.setAttribute("aria-sort", "asc" == n[0].dir ? "ascending" : "descending"), a[n[0].index + 1])) || a[0]) ? r.sSortAscending : r.sSortDescending)
                        : l),
        ...
        function Ze(t, n, i, o) {
            ...
            "number" == typeof c[0] && (c = t.aaSorting = [c]),
                i && t.oFeatures.bSortMulti
                    ? -1 !== (l = e.inArray(n, S(c, "0")))
                        ? null === (a = null === (a = s(c[l], !0)) && 1 === c.length ? 0 : a)
                            ? c.splice(l, 1)
                            : ((c[l][1] = u[a]), (c[l]._idx = a))
                        : (c.push([n, u[0], 0]), (c[c.length - 1]._idx = 0))
                    : c.length && c[0][0] == n
                    ? ((a = s(c[0])), (c.length = 1), (c[0][1] = u[a]), (c[0]._idx = a))
                    : ((c.length = 0), c.push([n, u[0]]), (c[0]._idx = 0)),
                le(t),
            ...
            ut(t, {}, function (t) {
                !1 !== i.bSortable &&
                    (e.oFeatures.bProcessing
                        ? (Me(e, !0),
                          setTimeout(function () {
                              Ze(e, n, t.shiftKey, r), "ssp" !== gt(e) && Me(e, !1);
                          }, 0))
                        : Ze(e, n, t.shiftKey, r));
            });
        }
        function tt(t) {
            ...
            if (l.bSort && l.bSortClasses) {
                for (n = 0, r = o.length; n < r; n++) (i = o[n].src), e(S(t.aoData, "anCells", i)).removeClass(s + (n < 2 ? n + 1 : 3));
                for (n = 0, r = a.length; n < r; n++) (i = a[n].src), e(S(t.aoData, "anCells", i)).addClass(s + (n < 2 ? n + 1 : 3));
            }
            t.aLastSort = a;
        }
        function nt(e, t) {
            for (var n, r, i, o = e.aoColumns[t], s = p.ext.order[o.sSortDataType], a = (s && (n = s.call(e.oInstance, e, t, H(e, t))), p.ext.type.order[o.sType + "-pre"]), l = 0, c = e.aoData.length; l < c; l++)
                (r = e.aoData[l])._aSortData || (r._aSortData = []), (r._aSortData[t] && !s) || ((i = s ? n[l] : U(e, l, t, "sort")), (r._aSortData[t] = a ? a(i) : i));
        }
        function rt(t) {
            var n;
            t._bLoadingState ||
                ((n = {
                    ...
                    columns: e.map(t.aoColumns, function (e, n) {
                        return { visible: e.bVisible, search: Ae(t.aoPreSearchCols[n]) };
                    }),
                }),
                (t.oSavedState = n),
        ...
        function it(e, t, n) {
            ...
            if (e.oFeatures.bStateSave)
                return (
                    (i = e.fnStateLoadCallback.call(e.oInstance, e, function (t) {
                        ot(e, t, n);
                    })) !== r && ot(e, i, n),
                    !0
                );
        ...
        function ot(t, n, i) {
            var o,
                s,
                a = t.aoColumns,
                l = ((t._bLoadingState = !0), t._bInitComplete ? new p.Api(t) : null);
            if (n && n.time) {
                var c = dt(t, "aoStateLoadParams", "stateLoadParams", [t, n]);
                if (-1 !== e.inArray(!1, c)) t._bLoadingState = !1;
                else if (0 < (c = t.iStateDuration) && n.time < +new Date() - 1e3 * c) t._bLoadingState = !1;
                else if (n.columns && a.length !== n.columns.length) t._bLoadingState = !1;
                else {
                    if (
                        ((t.oLoadedState = e.extend(!0, {}, n)),
                        n.length !== r && (l ? l.page.len(n.length) : (t._iDisplayLength = n.length)),
                        n.start !== r && (null === l ? ((t._iDisplayStart = n.start), (t.iInitDisplayStart = n.start)) : Re(t, n.start / t._iDisplayLength)),
                        n.order !== r &&
                            ((t.aaSorting = []),
                        ...
                        for (o = 0, s = n.columns.length; o < s; o++) {
                            var u = n.columns[o];
                            u.visible !== r && (l ? l.column(o).visible(u.visible, !1) : (a[o].bVisible = u.visible)), u.search !== r && e.extend(t.aoPreSearchCols[o], Ee(u.search));
                        }
                        l && l.columns.adjust();
                    }
                    (t._bLoadingState = !1), dt(t, "aoStateLoaded", "stateLoaded", [t, n]);
                }
        ...
        function at(e, n, r, i) {
            if (((r = "DataTables warning: " + (e ? "table id=" + e.sTableId + " - " : "") + r), i && (r += ". For more information about this error, please see http://datatables.net/tn/" + i), n))
                t.console && console.log && console.log(r);
            else if (((n = (n = p.ext).sErrMode || n.errMode), e && dt(e, null, "error", [e, i, r]), "alert" == n)) alert(r);
            else {
        ...
        function ct(t, n, r) {
            var i, o;
            for (o in n) n.hasOwnProperty(o) && ((i = n[o]), e.isPlainObject(i) ? (e.isPlainObject(t[o]) || (t[o] = {}), e.extend(!0, t[o], i)) : r && "data" !== o && "aaData" !== o && Array.isArray(i) ? (t[o] = i.slice()) : (t[o] = i));
            return t;
        }
        function ut(t, n, r) {
            e(t)
        ...
        function dt(t, n, r, i) {
            ...
            return (
                ...
                null !== r && ((n = e.Event(r + ".dt")), e(t.nTable).trigger(n, i), o.push(n.result)),
                o
            );
        }
        function ht(e) {
            ...
            n &&
                ...
                "ssp" == gt(e)
                    ...
                    : (Me(e, !0),
                      ...
                      de(e, [], function (n) {
                          Z(e);
                          for (var r = me(e, n), i = 0, o = r.length; i < o; i++) $(e, r[i]);
                          le(e, t), Me(e, !1);
                      }));
        }
        function yt(e, t, n, i, o) {
            for (var s, a, l, c, u = [], d = typeof t, h = 0, p = (t = t && "string" != d && "function" != d && t.length !== r ? t : [t]).length; h < p; h++)
                for (l = 0, c = (a = t[h] && t[h].split && !t[h].match(/[\[\(:]/) ? t[h].split(",") : [t[h]]).length; l < c; l++) (s = n("string" == typeof a[l] ? a[l].trim() : a[l])) && s.length && (u = u.concat(s));
            var g = f.selector[e];
            if (g.length) for (h = 0, p = g.length; h < p; h++) u = g[h](i, o, u);
            return T(u);
        }
        function bt(t) {
            return (t = t || {}).filter && t.search === r && (t.search = t.filter), e.extend({ search: "none", order: "current", page: "all" }, t);
        }
        function _t(e) {
        ...
        function wt(t, n) {
            ...
            if (r.length && t.length && (s = r[0].aoData[t[0]])._details) {
                (s._detailsShow = n) ? (s._details.insertAfter(s.nTr), e(s.nTr).addClass("dt-hasChild")) : (s._details.detach(), e(s.nTr).removeClass("dt-hasChild")), dt(r[0], null, "childRow", [n, t.row(t[0])]);
                var i = r[0],
                    o = new Ct(i),
                    s = ((n = "draw" + (s = ".dt.DT_details")), (t = "column-sizing" + s), "destroy" + s),
                    a = i.aoData;
                o.off(n + " " + t + " " + s),
                    S(a, "_details").length > 0 &&
                        (o.on(n, function (e, t) {
                            i === t &&
                                o
                                    .rows({ page: "current" })
                        ...
                        o.on(t, function (e, t, n, r) {
                            if (i === t) for (var o, s = M(t), l = 0, c = a.length; l < c; l++) (o = a[l])._details && o._details.children("td[colspan]").attr("colspan", s);
                        }),
                        o.on(s, function (e, t) {
                            if (i === t) for (var n = 0, r = a.length; n < r; n++) a[n]._details && Et(o, n);
                        })),
                    At(r);
            }
        }
        function xt(e, t, n, r, i) {
            for (var o = [], s = 0, a = i.length; s < a; s++) o.push(U(e, i[s], t));
            return o;
        }
        var St = [],
            Tt = Array.prototype,
            Ct = function (t, n) {
                    ...
                    (o = p.settings),
                        ...
                        (t = t
                            ? t.nTable && t.oApi
                                ...
                                ? t.settings().toArray()
                                : ("string" == typeof t ? (r = e(t)) : t instanceof e && (r = t),
                                  r
                                      ? r
                                            .map(function (t) {
                ...
                var i = [];
                if (Array.isArray(t)) for (var o = 0, s = t.length; o < s; o++) r(t[o]);
                else r(t);
                (this.context = T(i)), n && e.merge(this, n), (this.selector = { rows: null, cols: null, opts: null }), Ct.extend(this, this, St);
            },
            Dt =
                ((p.Api = Ct),
                e.extend(Ct.prototype, {
                    ...
                    filter: function (e) {
                        ...
                        else for (var n = 0, r = this.length; n < r; n++) e.call(this, this[n], n, this) && t.push(this[n]);
                    ...
                    iterator: function (e, t, n, i) {
                        var o,
                            ...
                            p = this.context,
                            g = this.selector;
                        for ("string" == typeof e && ((i = n), (n = t), (t = e), (e = !1)), s = 0, a = p.length; s < a; s++) {
                            var m = new Ct(p[s]);
                            if ("table" === t) (o = n.call(m, p[s], s)) !== r && h.push(o);
                            else if ("columns" === t || "rows" === t) (o = n.call(m, p[s], this[s], s)) !== r && h.push(o);
                            else if ("column" === t || "column-rows" === t || "row" === t || "cell" === t)
                                for (f = this[s], "column-rows" === t && (u = Dt(p[s], g.opts)), l = 0, c = f.length; l < c; l++)
                                    (d = f[l]), (o = "cell" === t ? n.call(m, p[s], d.row, d.column, s, l) : n.call(m, p[s], d, s, l, u)) !== r && h.push(o);
                        }
                        return h.length || i ? (((e = (i = new Ct(p, e ? h.concat.apply([], h) : h)).selector).rows = g.rows), (e.cols = g.cols), (e.opts = g.opts), i) : this;
                    },
                    lastIndexOf:
                        Tt.lastIndexOf ||
                        function (e, t) {
                    ...
                    map: function (e) {
                        ...
                        else for (var n = 0, r = this.length; n < r; n++) t.push(e.call(this, this[n], n));
                        return new Ct(this.context, t);
                    },
                    pluck: function (e) {
                        let t = p.util.get(e);
                ...
                (Ct.register = d = function (t, n) {
                    if (Array.isArray(t)) for (var r = 0, i = t.length; r < i; r++) Ct.register(t[r], n);
                    else
                        for (var o = t.split("."), s = St, a = 0, l = o.length; a < l; a++) {
                            ...
                            f || s.push((f = { name: u, val: {}, methodExt: [], propExt: [], type: "object" })),
                                a === l - 1 ? ((f.val = n), (f.type = "function" == typeof n ? "function" : e.isPlainObject(n) ? "object" : "other")) : (s = c ? f.methodExt : f.propExt);
                        }
                }),
                ...
                d("page.info()", function (e) {
                    ...
                    return 0 === this.context.length
                        ...
                        : ((n = (t = this.context[0])._iDisplayStart),
                          ...
                          { page: (s = -1 === i) ? 0 : Math.floor(n / i), pages: s ? 1 : Math.ceil(o / i), start: n, end: t.fnDisplayEnd(), length: i, recordsTotal: t.fnRecordsTotal(), recordsDisplay: o, serverSide: "ssp" === gt(t) });
                }),
                d("page.len()", function (e) {
                    return e === r
                ...
                d("ajax.reload()", function (e, t) {
                    return this.iterator("table", function (n) {
                        vt(n, !1 === t, e);
                    });
                }),
                d("ajax.url()", function (t) {
                    var n = this.context;
                    return t === r
                        ? 0 === n.length
                            ? r
                ...
                function (t, n) {
                    var r,
                        ...
                        c = n.order;
                    n = n.page;
                    if ("ssp" == gt(t)) return "removed" === a ? [] : l(0, s.length);
                    if ("current" == n) for (f = t._iDisplayStart, d = t.fnDisplayEnd(); f < d; f++) i.push(o[f]);
                    else if ("current" == c || "applied" == c) {
                        if ("none" == a) i = s.slice();
                        else if ("applied" == a) i = o.slice();
                        else if ("removed" == a) {
                            for (var u = {}, f = 0, d = o.length; f < d; f++) u[o[f]] = null;
                            i = e.map(s, function (e) {
                                return u.hasOwnProperty(e) ? null : e;
                            });
                        }
                    } else if ("index" == c || "original" == c) for (f = 0, d = t.aoData.length; f < d; f++) ("none" == a || (-1 === (r = e.inArray(f, o)) && "removed" == a) || (0 <= r && "applied" == a)) && i.push(f);
                    return i;
                }),
            At =
                (d("rows()", function (t, n) {
                        ...
                        function (o) {
                            return yt(
                                ...
                                function (t) {
                                    ...
                                    if (((u = u || Dt(s, l)), null !== n && -1 !== e.inArray(n, u))) return [n];
                                    ...
                                    if (t.nodeName)
                                        return (
                                            (n = t._DT_RowIndex),
                                            (f = t._DT_CellIndex),
                                            n !== r ? (o[n] && o[n].nTr === t ? [n] : []) : f ? (o[f.row] && o[f.row].nTr === t.parentNode ? [f.row] : []) : (n = e(t).closest("*[data-dt-row]")).length ? [n.data("dt-row")] : []
                                        );
                                    if ("string" == typeof t && "#" === t.charAt(0)) {
                                        var f = s.aIds[t.replace(/^#/, "")];
                                        if (f !== r) return [f.idx];
                                    }
                                    return (
                                        (n = c(a(s.aoData, u, "nTr"))),
                                        e(n)
                                            .filter(t)
                                            .map(function () {
                ...
                h("rows().remove()", "row().remove()", function () {
                    var e = this;
                    return (
                        this.iterator("row", function (t, n, i) {
                            var o,
                                s,
                                a,
                                l,
                                ...
                                f = t.aoData,
                                d = f[n];
                            for (f.splice(n, 1), o = 0, s = f.length; o < s; o++) if (((u = (c = f[o]).anCells), null !== c.nTr && (c.nTr._DT_RowIndex = o), null !== u)) for (a = 0, l = u.length; a < l; a++) u[a]._DT_CellIndex.row = o;
                            ee(t.aiDisplayMaster, n), ee(t.aiDisplay, n), ee(e[i], n, !1), 0 < t._iRecordsDisplay && t._iRecordsDisplay--, ht(t), (i = t.rowIdFn(d._aData)) !== r && delete t.aIds[i];
                        }),
                ...
                d("rows.add()", function (t) {
                    var n = this.iterator(
                            "table",
                            function (e) {
                                for (var n, r = [], i = 0, o = t.length; i < o; i++) (n = t[i]).nodeName && "TR" === n.nodeName.toUpperCase() ? r.push(z(e, n)[0]) : r.push($(e, n));
                                return r;
                            },
                            1
                        ),
                ...
                d("row().data()", function (e) {
                    ...
                    return e === r
                        ? n.length && this.length
                            ...
                            : r
                        : (((t = n[0].aoData[this[0]])._aData = e), Array.isArray(e) && t.nTr && t.nTr.id && G(n[0].rowId)(e, t.nTr.id), te(n[0], this[0], "data"), this);
                }),
                d("row().node()", function () {
                    var e = this.context;
                    return (e.length && this.length && e[0].aoData[this[0]].nTr) || null;
                }),
                d("row.add()", function (t) {
                    t instanceof e && t.length && (t = t[0]);
                    var n = this.iterator("table", function (e) {
                        return t.nodeName && "TR" === t.nodeName.toUpperCase() ? z(e, t)[0] : $(e, t);
                    });
                    return this.row(n[0]);
                }),
                e(n).on("plugin-init.dt", function (t, n) {
                    var r = new Ct(n),
                        i = "on-plugin-init";
                    const o = "stateSaveParams." + i,
                        s = "destroy." + i;
                    r.on(o, function (e, t, n) {
                        for (var r = t.rowIdFn, i = t.aoData, o = [], s = 0; s < i.length; s++) i[s]._detailsShow && o.push("#" + r(i[s]._aData));
                        n.childRows = o;
                    }),
                        r.on(s, function () {
                            r.off(o + " " + s);
                        ...
                        (i = r.state.loaded()) &&
                            ...
                            r
                                .rows(
                                    e.map(i.childRows, function (e) {
                                        return e.replace(/:/g, "\\:");
                                    })
                                )
                                .every(function () {
                                    dt(n, null, "requestChild", [this]);
                                });
                }),
            ...
            Et = function (t, n) {
                var i = t.context;
                i.length && (n = i[0].aoData[n !== r ? n : t[0]]) && n._details && (n._details.remove(), (n._detailsShow = r), (n._details = r), e(n.nTr).removeClass("dt-hasChild"), At(i));
            },
            kt = "row().child",
            Lt = kt + "()",
            It =
                        ...
                        : (!0 === t
                              ...
                              : i.length &&
                                ...
                                (function (t, n, r, i) {
                                    ...
                                    (function n(r, i) {
                                        var s;
                                        if (Array.isArray(r) || r instanceof e) for (var a = 0, l = r.length; a < l; a++) n(r[a], i);
                                        else r.nodeName && "tr" === r.nodeName.toLowerCase() ? o.push(r) : ((s = e("<tr><td></td></tr>").addClass(i)), (e("td", s).addClass(i).html(r)[0].colSpan = M(t)), o.push(s[0]));
                                    })(r, i),
                ...
                d([kt + ".show()", Lt + ".show()"], function (e) {
                    return wt(this, !0), this;
                }),
                d([kt + ".hide()", Lt + ".hide()"], function () {
                    return wt(this, !1), this;
                }),
                d([kt + ".remove()", Lt + ".remove()"], function () {
                    return Et(this), this;
                }),
                d(kt + ".isShown()", function () {
                    var e = this.context;
                    return (e.length && this.length && e[0].aoData[this[0]]._detailsShow) || !1;
                }),
                /^([^:]+):(name|visIdx|visible)$/),
            jt =
                (d("columns()", function (t, n) {
                    t === r ? (t = "") : e.isPlainObject(t) && ((n = t), (t = "")), (n = bt(n));
                    var o = this.iterator(
                        "table",
                        function (r) {
                                    ...
                                    function (t) {
                                        ...
                                        if ("function" == typeof t)
                                            return (
                                                ...
                                                e.map(c, function (e, r) {
                                                    return t(r, xt(o, r, 0, 0, n), f[r]) ? r : null;
                                                })
                                            );
                                        ...
                                        return t.nodeName && t._DT_CellIndex
                                            ...
                                            : (r = e(f)
                                                  .filter(t)
                                                  .map(function () {
                                                      return e.inArray(this, f);
                                                  })
                                                  .toArray()).length || !t.nodeName
                                            ? r
                                            : (r = e(t).closest("*[data-dt-column]")).length
                                            ? [r.data("dt-column")]
                                            : [];
                                    },
                                    o,
                    ...
                    var i = this,
                        o = this.iterator("column", function (n, i) {
                            ...
                            if (i === r) c.bVisible;
                                ...
                                if (i) for (var f = e.inArray(!0, S(l, "bVisible"), a + 1), d = 0, h = u.length; d < h; d++) (s = u[d].nTr), (o = u[d].anCells), s && s.insertBefore(o[a], o[f] || null);
                                else e(S(n.aoData, "anCells", a)).detach();
                                c.bVisible = i;
                            }
                        });
                    return (
                ...
                d("column.index()", function (e, t) {
                    var n;
                    if (0 !== this.context.length) return (n = this.context[0]), "fromVisible" === e || "toData" === e ? R(n, t) : "fromData" === e || "toVisible" === e ? H(n, t) : void 0;
                }),
                d("column()", function (e, t) {
                    return _t(this.columns(e, t));
                }),
                d("cells()", function (t, n, i) {
                    var o, s, l, u, f, d, h;
                    return (
                        e.isPlainObject(t) && (t.row === r ? ((i = t), (t = null)) : ((i = n), (n = null))),
                        e.isPlainObject(n) && ((i = n), (n = null)),
                        null === n || n === r
                            ? this.iterator("table", function (n) {
                                  return (
                                      (o = n),
                                      ...
                                      yt(
                                          ...
                                          function (t) {
                                              var n,
                                                  i = "function" == typeof t;
                                              if (null === t || t === r || i) {
                                                  for (u = [], f = 0, d = v.length; f < d; f++)
                                                      for (l = v[f], h = 0; h < _; h++) (p = { row: l, column: h }), (!i || ((g = m[l]), t(p, U(o, l, h), g.anCells ? g.anCells[h] : null))) && u.push(p);
                                                  return u;
                                              }
                                              return e.isPlainObject(t)
                                                  ? t.column !== r && t.row !== r && -1 !== e.inArray(t.row, v)
                                                      ? [t]
                                                      : []
                                                  : (n = b
                                                        .filter(t)
                                  ...
                                  var o, s, l, u, f, d, h, p, g, m, v, y, b, _;
                              })
                            : ((h = i ? { page: i.page, order: i.order, search: i.search } : {}),
                              (o = this.columns(n, h)),
                              (s = this.rows(t, h)),
                              (h = this.iterator(
                                  "table",
                                  function (e, t) {
                                      var n = [];
                                      for (l = 0, u = s[t].length; l < u; l++) for (f = 0, d = o[t].length; f < d; f++) n.push({ row: s[t][l], column: o[t][f] });
                                      return n;
                                  },
                                  1
                              )),
                              (h = i && i.selected ? this.cells(h, i) : h),
                              e.extend(h.selector, { cols: n, rows: t, opts: i }),
                              h)
                    );
                }),
                ...
                h("cells().indexes()", "cell().index()", function () {
                    return this.iterator(
                        "cell",
                        function (e, t, n) {
                            return { row: t, column: n, columnVisible: H(e, n) };
                        },
                        1
                    );
                }),
                ...
                d("cell()", function (e, t, n) {
                    return _t(this.cells(e, t, n));
                }),
                d("cell().data()", function (e) {
                    var t = this.context,
                        n = this[0];
                    return e === r ? (t.length && n.length ? U(t[0], n[0].row, n[0].column) : r) : (V(t[0], n[0].row, n[0].column, e), te(t[0], n[0].row, "data", n[0].column), this);
                }),
                d("order()", function (e, t) {
                    var n = this.context;
                    return e === r
                        ? 0 !== n.length
                            ? n[0].aaSorting
                ...
                d("order.listener()", function (e, t, n) {
                    return this.iterator("table", function (r) {
                        et(r, e, t, n);
                    });
                }),
                d("order.fixed()", function (t) {
                    var n;
                    return t
                        ? this.iterator("table", function (n) {
                              n.aaSortingFixed = e.extend(!0, {}, t);
                          })
                        : ((n = (n = this.context).length ? n[0].aaSortingFixed : r), Array.isArray(n) ? { pre: n } : n);
                }),
                d(["columns().order()", "column().order()"], function (t) {
                    var n = this;
                ...
                d("search()", function (t, n, i, o) {
                    ...
                    return t === r
                        ...
                        : this.iterator("table", function (r) {
                              r.oFeatures.bFilter && ye(r, e.extend({}, r.oPreviousSearch, { sSearch: t + "", bRegex: null !== n && n, bSmart: null === i || i, bCaseInsensitive: null === o || o }), 1);
                          });
                }),
                h("columns().search()", "column().search()", function (t, n, i, o) {
                    return this.iterator("column", function (s, a) {
                        var l = s.aoPreSearchCols;
                        if (t === r) return l[a].sSearch;
                        s.oFeatures.bFilter && (e.extend(l[a], { sSearch: t + "", bRegex: null !== n && n, bSmart: null === i || i, bCaseInsensitive: null === o || o }), ye(s, s.oPreviousSearch, 1));
                    });
                }),
                d("state()", function () {
                ...
                (p.versionCheck = p.fnVersionCheck = function (e) {
                    for (var t, n, r = p.version.split("."), i = e.split("."), o = 0, s = i.length; o < s; o++) if ((t = parseInt(r[o], 10) || 0) !== (n = parseInt(i[o], 10) || 0)) return n < t;
                    return !0;
                }),
                (p.isDataTable = p.fnIsDataTable = function (t) {
                    ...
                    return (
                        t instanceof p.Api ||
                        (e.each(p.settings, function (t, i) {
                    ...
                    return (
                        ...
                        this.iterator("table", function (r) {
                            var i,
                                ...
                                c = r.nTFoot,
                                u = e(s),
                                f = ((a = e(a)), e(r.nTableWrapper)),
                                d = e.map(r.aoData, function (e) {
                                    return e.nTr;
                                });
                            (r.bDestroying = !0),
                                dt(r, "aoDestroyCallback", "destroy", [r]),
                                n || new Ct(r).columns().visible(!0),
                                f.off(".DT").find(":not(tbody *)").off(".DT"),
                                e(t).off(".DT-" + r.sInstance),
                                s != l.parentNode && (u.children("thead").detach(), u.append(l)),
                                c && s != c.parentNode && (u.children("tfoot").detach(), u.append(c)),
                                (r.aaSorting = []),
                                (r.aaSortingFixed = []),
                                tt(r),
                                e(d).removeClass(r.asStripeClasses.join(" ")),
                                ...
                                !n &&
                                    c &&
                                    (c.insertBefore(s, r.nTableReinsertBefore),
                ...
                d("i18n()", function (t, n, i) {
                    var o = this.context[0];
                    return (t = Q(t)(o.oLanguage)) === r && (t = n), (t = i !== r && e.isPlainObject(t) ? (t[i] !== r ? t[i] : t._) : t).replace("%d", i);
                }),
                (p.version = "1.13.1"),
                (p.settings = []),
                (p.models = {}),
                (p.models.oSearch = { bCaseInsensitive: !0, sSearch: "", bRegex: !1, bSmart: !0, return: !1 }),
                ...
                e.extend(f, { afnFiltering: f.search, aTypes: f.type.detect, ofnSearch: f.type.search, oSort: f.type.order, afnSortData: f.order, aoFeatures: f.feature, oApi: f.internal, oStdClasses: f.classes, oPagination: f.pager }),
        ...
        function Ot(e, t) {
            ...
            return (
                t <= r
                    ? (n = l(0, t))
                    : e <= i
                    ? ((n = l(0, r - 2)).push("ellipsis"), n.push(t - 1))
                    : ((t - 1 - i <= e ? (n = l(t - (r - 2), t)) : ((n = l(e - i + 2, e + i - 1)).push("ellipsis"), n.push(t - 1), n)).splice(0, 0, "ellipsis"), n.splice(0, 0, 0)),
                (n.DT_el = "span"),
                n
            );
        }
        function Nt(e, t, n, r) {
            return 0 === e || (e && "-" !== e) ? ((e = t ? x(e, t) : e).replace && (n && (e = e.replace(n, "")), r && (e = e.replace(r, ""))), +e) : -1 / 0;
        }
        function Pt(t) {
            e.each(
                {
                ...
                function (e, n) {
                    (f.type.order[e + t + "-pre"] = n), e.match(/^html\-/) && (f.type.search[e + t] = f.type.search.html);
                }
            );
        }
        function Ft(e) {
        ...
        e.extend(jt, {
            ...
            simple_numbers: function (e, t) {
                return ["previous", Ot(e, t), "next"];
            },
            full_numbers: function (e, t) {
                return ["first", "previous", Ot(e, t), "next", "last"];
            },
            first_last_numbers: function (e, t) {
                return ["first", Ot(e, t), "last"];
            },
            _numbers: Ot,
            numbers_length: 7,
        }),
                    ...
                    _: function (t, i, o, s, a, l) {
                        ...
                        (function n(r, i) {
                            for (
                                ...
                                if (((s = i[v]), Array.isArray(s))) {
                                    n(e("<" + (s.DT_el || "div") + "/>").appendTo(r), s);
                                } else {
                                    switch (((c = null), (u = s), (f = t.iTabIndex), s)) {
                                        case "ellipsis":
                                            r.append('<span class="ellipsis">&#x2026;</span>');
                                            break;
                                        case "first":
                                            (c = h.sFirst), 0 === a && ((f = -1), (u += " " + g));
                                            break;
                                        case "previous":
                                            (c = h.sPrevious), 0 === a && ((f = -1), (u += " " + g));
                                            break;
                                        case "next":
                                            (c = h.sNext), (0 !== l && a !== l - 1) || ((f = -1), (u += " " + g));
                                            break;
                                        case "last":
                                            (c = h.sLast), (0 !== l && a !== l - 1) || ((f = -1), (u += " " + g));
                                            break;
                                        default:
                                            (c = t.fnFormatNumber(s + 1)), (u = a === s ? d.sPageButtonActive : "");
                                    }
                                    null !== c &&
                                        ut(
                                            e("<a>", { class: d.sPageButton + " " + u, "aria-controls": t.sTableId, "aria-label": p[s], "data-dt-idx": s, tabindex: f, id: 0 === o && "string" == typeof s ? t.sTableId + "_" + s : null })
                                                .html(c)
                                                .appendTo(r),
                                            { action: s },
                                            m
                ...
                header: {
                    _: function (t, n, r, i) {
                        e(t.nTable).on("order.dt.DT", function (e, o, s, a) {
                            t === o && ((o = r.idx), n.removeClass(i.sSortAsc + " " + i.sSortDesc).addClass("asc" == a[o] ? i.sSortAsc : "desc" == a[o] ? i.sSortDesc : r.sSortingClass));
                        });
                    },
                    jqueryui: function (t, n, r, i) {
                        e("<div/>")
                            ...
                            .append(n.contents())
                            .append(e("<span/>").addClass(i.sSortIcon + " " + r.sSortingClassJUI))
                            .appendTo(n),
                            e(t.nTable).on("order.dt.DT", function (e, o, s, a) {
                                t === o &&
                                    ((o = r.idx),
                                    ...
                                    n
                                        ...
                                        .addClass("asc" == a[o] ? i.sSortJUIAsc : "desc" == a[o] ? i.sSortJUIDesc : r.sSortingClassJUI));
                            });
                    },
                },
            });
        ...
        function Mt(e, n, r) {
            ...
            if (t.moment) {
                ...
                i.setLocale(r);
            } else n ? (Ht || alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17"), (Ht = !0)) : (i = new Date(e));
            return i;
        }
        function qt(e) {
            return function (t, n, i, o) {
                ...
                return (
                    ...
                    function (a, l) {
                        var c;
                        return (
                            (null !== a && a !== r) || (a = "--now" === o ? ((c = new Date()), new Date(Date.UTC(c.getFullYear(), c.getMonth(), c.getDate(), c.getHours(), c.getMinutes(), c.getSeconds()))) : ""),
                            "type" === l
                                ? s
                                : "" === a
                                ? "sort" !== l
                                    ? ""
                                    : Mt("0000-01-01 00:00:00", null, i)
                                : (null === n || t !== n || "sort" === l || "type" === l || a instanceof Date) && null !== (c = Mt(a, t, i))
                                ? "sort" === l
                                    ? c
                                    : ((a = null === n ? Rt(c, "toDate", "toJSDate", "")[e]() : Rt(c, "format", "toFormat", "toISOString", n)), "display" === l ? Ft(a) : a)
                                : a
                        );
                    }
                );
        ...
        if (Intl)
            try {
                for (var $t = new Intl.NumberFormat().formatToParts(100000.1), zt = 0; zt < $t.length; zt++) "group" === $t[zt].type ? (Wt = $t[zt].value) : "decimal" === $t[zt].type && (Bt = $t[zt].value);
            } catch (h) {}
        function Ut(e) {
            return function () {
        ...
        return (
            (p.datetime = function (e, t) {
                ...
                (t = t || "en"),
                    p.ext.type.order[n] ||
                        (p.ext.type.detect.unshift(function (r) {
                            var i = Mt(r, e, t);
                            return !("" !== r && !i) && n;
                        }),
            ...
            (p.render = {
                date: qt("toLocaleDateString"),
                datetime: qt("toLocaleString"),
                time: qt("toLocaleTimeString"),
    ...
    (function (e, t) {
        ...
        function u(e, i, o) {
            ...
            var s = e.getBoundingClientRect(),
                l = 1,
                u = 1;
            i && r(e) && ((l = (e.offsetWidth > 0 && a(s.width) / e.offsetWidth) || 1), (u = (e.offsetHeight > 0 && a(s.height) / e.offsetHeight) || 1));
            var f = (n(e) ? t(e) : window).visualViewport,
                d = !c() && o,
                h = (s.left + (d && f ? f.offsetLeft : 0)) / l,
                p = (s.top + (d && f ? f.offsetTop : 0)) / u,
                g = s.width / l,
                m = s.height / u;
        ...
        function p(e) {
            return u(h(e)).left + f(e).scrollLeft;
        }
        function g(e) {
        ...
        function v(e, n, i) {
            ...
            return (
                (l || (!l && !i)) &&
                    (("body" !== d(n) || m(g)) && (y = (o = n) !== t(o) && r(o) ? { scrollLeft: (s = o).scrollLeft, scrollTop: s.scrollTop } : f(o)), r(n) ? (((b = u(n, !0)).x += n.clientLeft), (b.y += n.clientTop)) : g && (b.x = p(g))),
                { x: v.left + y.scrollLeft - b.x, y: v.top + y.scrollTop - b.y, width: v.width, height: v.height }
            );
        }
        function y(e) {
            var t = u(e),
        ...
        function _(e) {
            return ["html", "body", "#document"].indexOf(d(e)) >= 0 ? e.ownerDocument.body : r(e) && m(e) ? e : _(b(e));
        }
        function w(e, n) {
            var r;
            void 0 === n && (n = []);
        ...
        function T(e) {
            for (var n = t(e), o = S(e); o && x(o) && "static" === g(o).position; ) o = S(o);
            return o && ("html" === d(o) || ("body" === d(o) && "static" === g(o).position))
                ? n
                : o ||
                      (function (e) {
                          var t = /firefox/i.test(l());
                          if (/Trident/i.test(l()) && r(e) && "fixed" === g(e).position) return null;
                          var n = b(e);
                          for (i(n) && (n = n.host); r(n) && ["html", "body"].indexOf(d(n)) < 0; ) {
                              var o = g(n);
                              if (
                                  "none" !== o.transform ||
                                  "none" !== o.perspective ||
            ...
            return r === O
                ? W(
                      (function (e, n) {
                          ...
                          return { width: s, height: a, x: l + p(e), y: u };
                      })(e, i)
                  )
                : n(r)
                ? (function (e, t) {
                ...
                : W(
                      (function (e) {
                          var t,
                              ...
                              s = o(n.scrollWidth, n.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0),
                              a = o(n.scrollHeight, n.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0),
                              l = -r.scrollLeft + p(e),
                              c = -r.scrollTop;
                          return "rtl" === g(i || n).direction && (l += o(n.clientWidth, i ? i.clientWidth : 0) - s), { width: s, height: a, x: l, y: c };
                      })(h(e))
                  );
        }
        function $(e, t, i, a) {
            var l =
                ...
                f = c.reduce(function (t, n) {
                    var r = B(e, n, a);
                    return (t.top = o(r.top, t.top)), (t.right = s(r.right, t.right)), (t.bottom = s(r.bottom, t.bottom)), (t.left = o(r.left, t.left)), t;
                }, B(e, u, a));
        ...
        function Y(e, t) {
            ...
            var r = t,
                ...
                x = e.rects.popper,
                S = e.elements[v ? w : g],
                T = $(n(S) ? S : S.contextElement || h(e.elements.popper), c, d, a),
                E = u(e.elements.reference),
                k = V({ reference: E, element: x, strategy: "absolute", placement: o }),
                I = W(Object.assign({}, x, k)),
                j = g === N ? I : E,
                P = { top: T.top - j.top + _.top, bottom: j.bottom - T.bottom + _.bottom, left: T.left - j.left + _.left, right: j.right - T.right + _.right },
        ...
        function K(e) {
            ...
            return function (e, t, r) {
                ...
                var o,
                    a,
                    l = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, Q, s), modifiersData: {}, elements: { reference: e, popper: t }, attributes: {}, styles: {} },
                    c = [],
                    u = !1,
                    f = {
                        state: l,
                        setOptions: function (r) {
                            ...
                            d(), (l.options = Object.assign({}, s, l.options, o)), (l.scrollParents = { reference: n(e) ? w(e) : e.contextElement ? w(e.contextElement) : [], popper: w(t) });
                            var a,
                                u,
                                h = (function (e) {
                                    var t = H(e);
                            ...
                            return (
                                ...
                                l.orderedModifiers.forEach(function (e) {
                                    ...
                                    if ("function" == typeof i) {
                                        var o = i({ state: l, name: t, instance: f, options: r });
                                        c.push(o || function () {});
                                    }
                                }),
                                f.update()
                        ...
                        forceUpdate: function () {
                            if (!u) {
                                var e = l.elements,
                                    ...
                                    n = e.popper;
                                if (G(t, n)) {
                                    (l.rects = { reference: v(t, T(n), "fixed" === l.options.strategy), popper: y(n) }),
                                        (l.reset = !1),
                                    ...
                                    for (var r = 0; r < l.orderedModifiers.length; r++)
                                        if (!0 !== l.reset) {
                                            var i = l.orderedModifiers[r],
                                                ...
                                                a = void 0 === s ? {} : s,
                                                c = i.name;
                                            "function" == typeof o && (l = o({ state: l, options: a, name: c, instance: f }) || l);
                                        } else (l.reset = !1), (r = -1);
                                }
                            }
                        },
        ...
        var Z = { passive: !0 },
            ...
            te = {
                ...
                fn: function (e) {
                    var t = e.state,
                        n = e.name;
                    t.modifiersData[n] = V({ reference: t.rects.reference, element: t.rects.popper, strategy: "absolute", placement: t.placement });
                },
                data: {},
            },
        ...
        function re(e) {
            var n,
                ...
                y = l.y,
                b = void 0 === y ? 0 : y,
                _ = "function" == typeof d ? d({ x: v, y: b }) : { x: v, y: b };
            (v = _.x), (b = _.y);
            ...
            if (f) {
                var I = T(r),
                    O = "clientHeight",
                    N = "clientWidth";
                I === t(r) && "static" !== g((I = h(r))).position && "absolute" === c && ((O = "scrollHeight"), (N = "scrollWidth")),
                    (o === C || ((o === E || o === A) && s === j)) && ((k = D), (b -= (p && I === L && L.visualViewport ? L.visualViewport.height : I[O]) - i.height), (b *= u ? 1 : -1)),
                    (o !== E && ((o !== C && o !== D) || s !== j)) || ((S = A), (v -= (p && I === L && L.visualViewport ? L.visualViewport.width : I[N]) - i.width), (v *= u ? 1 : -1));
            }
            var P,
                F = Object.assign({ position: c }, f && ne),
                R =
                    !0 === d
                        ? (function (e) {
                              var t = e.x,
            ...
            return (
                ...
                (b = R.y),
                u
                    ? Object.assign({}, F, (((P = {})[k] = x ? "0" : ""), (P[S] = w ? "0" : ""), (P.transform = (L.devicePixelRatio || 1) <= 1 ? "translate(" + v + "px, " + b + "px)" : "translate3d(" + v + "px, " + b + "px, 0)"), P))
                    : Object.assign({}, F, (((n = {})[k] = x ? b + "px" : ""), (n[S] = w ? v + "px" : ""), (n.transform = ""), n))
            );
        }
        var ie = {
                name: "computeStyles",
                ...
                fn: function (e) {
                    var t = e.state,
                        ...
                        a = n.roundOffsets,
                        l = void 0 === a || a,
                        c = { placement: M(t.placement), variation: z(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: i, isFixed: "fixed" === t.options.strategy };
                    null != t.modifiersData.popperOffsets &&
                        (t.styles.popper = Object.assign({}, t.styles.popper, re(Object.assign({}, c, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: s, roundOffsets: l })))),
                        null != t.modifiersData.arrow && (t.styles.arrow = Object.assign({}, t.styles.arrow, re(Object.assign({}, c, { offsets: t.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: l })))),
                            ...
                            return (
                                (e[n] = (function (e, t, n) {
                                    var r = M(e),
                                        ...
                                        s = o[0],
                                        a = o[1];
                                    return (s = s || 0), (a = (a || 0) * i), [E, A].indexOf(r) >= 0 ? { x: a, y: s } : { x: s, y: a };
                                })(n, t.rects, o)),
                                e
                            );
                        }, {}),
        ...
        function fe(e, t) {
            ...
            var h = d.reduce(function (t, n) {
                return (t[n] = Y(e, { placement: n, boundary: i, rootBoundary: o, padding: s })[M(n)]), t;
            }, {});
                    ...
                    for (
                        var i = n.mainAxis,
                            ...
                            b = [m].concat(y).reduce(function (e, n) {
                                return e.concat(M(n) === k ? fe(t, { placement: n, boundary: u, rootBoundary: f, padding: c, flipVariations: p, allowedAutoPlacements: g }) : n);
                            }, []),
                            _ = t.rects.reference,
                            w = t.rects.popper,
                            x = new Map(),
                        ...
                        var j = b[L],
                            ...
                            P = [C, D].indexOf(O) >= 0,
                            F = P ? "width" : "height",
                            R = Y(t, { placement: j, boundary: u, rootBoundary: f, altBoundary: d, padding: c }),
                            H = P ? (N ? A : E) : N ? D : C;
                        _[F] > w[F] && (H = le(H));
                        var q = le(H),
                            W = [];
        ...
        var pe = {
                ...
                fn: function (e) {
                    var t = e.state,
                        ...
                        m = n.tetherOffset,
                        v = void 0 === m ? 0 : m,
                        b = Y(t, { boundary: u, rootBoundary: f, padding: h, altBoundary: d }),
                        _ = M(t.placement),
                        w = z(t.placement),
                        x = !w,
                        S = U(_),
                        ...
                        P = "number" == typeof N ? { mainAxis: N, altAxis: N } : Object.assign({ mainAxis: 0, altAxis: 0 }, N),
                    ...
                    if (L) {
                        if (a) {
                            var H,
                                ...
                                G = w === I ? -O[B] : -j[B],
                                K = t.elements.arrow,
                                Z = g && K ? y(K) : { width: 0, height: 0 },
                                ee = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 },
                                te = ee[q],
                                ne = ee[W],
                                re = he(0, j[B], Z[B]),
                                ie = x ? j[B] / 2 - J - re - te - P.mainAxis : Q - re - te - P.mainAxis,
                                oe = x ? -j[B] / 2 + J + re + ne + P.mainAxis : G + re + ne + P.mainAxis,
                                se = t.elements.arrow && T(t.elements.arrow),
                                ae = se ? ("y" === S ? se.clientTop || 0 : se.clientLeft || 0) : 0,
                                le = null != (H = null == F ? void 0 : F[S]) ? H : 0,
                                ce = $ + oe - le,
                                ue = he(g ? s(V, $ + ie - le - ae) : V, $, g ? o(X, ce) : X);
                            (L[S] = ue), (R[S] = ue - $);
                        }
                        if (c) {
                            var fe,
                                ...
                                ye = ge - b[pe],
                                be = -1 !== [C, E].indexOf(_),
                                _e = null != (fe = null == F ? void 0 : F[k]) ? fe : 0,
                                we = be ? ve : ge - j[me] - O[me] - _e + P.altAxis,
                                xe = be ? ge + j[me] + O[me] - _e - P.altAxis : ye,
                                Se =
                                    g && be
                                        ? (function (e, t, n) {
                                              var r = he(e, t, n);
            ...
            ge = {
                ...
                fn: function (e) {
                    var t,
                        ...
                        a = M(n.placement),
                        l = U(a),
                        c = [E, A].indexOf(a) >= 0 ? "height" : "width";
                    if (o && s) {
                        var u = (function (e, t) {
                                return X("number" != typeof (e = "function" == typeof e ? e(Object.assign({}, t.rects, { placement: t.placement })) : e) ? e : J(e, L));
                            })(i.padding, n),
                            f = y(o),
                            d = "y" === l ? C : E,
                            h = "y" === l ? D : A,
        ...
        var ye = {
            ...
            be = K({ defaultModifiers: [ee, te, ie, oe] }),
            _e = [ee, te, ie, oe, se, de, pe, ge, ye],
            we = K({ defaultModifiers: _e });
        (e.applyStyles = oe),
            (e.arrow = ge),
            (e.computeStyles = ie),
            (e.createPopper = we),
    ...
    (function (e, t) {
        ...
        const t = (function (e) {
            ...
            b = (e, t, r = !0) => {
                ...
                let o = !1;
                const a = ({ target: r }) => {
                    r === t && ((o = !0), t.removeEventListener(n, a), y(e));
                };
        ...
        function j(e, t, n, r, i) {
            ...
            const f = E(s, t.replace(w, "")),
                d = o
                    ? (function (e, t, n) {
                          return function r(i) {
                              const o = e.querySelectorAll(t);
                              for (let { target: s } = i; s && s !== this; s = s.parentNode) for (const a of o) if (a === s) return R(i, { delegateTarget: s }), r.oneOff && F.off(e, i.type, t, n), n.apply(s, [i]);
                          };
                      })(e, n, s)
                    : (function (e, t) {
                          return function n(r) {
                              return R(r, { delegateTarget: e }), n.oneOff && F.off(e, r.type, t), t.apply(e, [r]);
                          };
                      })(e, s);
            (d.delegationSelector = o ? n : null), (d.callable = s), (d.oneOff = i), (d.uidEvent = f), (c[f] = d), e.addEventListener(a, d, o);
        }
        ...
        function N(e, t, n, r) {
            ...
            for (const o of Object.keys(i))
                if (o.includes(r)) {
                    const r = i[o];
                    O(e, t, n, r.callable, r.delegationSelector);
                }
        }
        function P(e) {
            return (e = e.replace(x, "")), D[e] || e;
        }
        const F = {
            on(e, t, n, r) {
                j(e, t, n, r, !1);
            ...
            off(e, t, n, r) {
                ...
                if (void 0 === o) {
                    ...
                    for (const n of Object.keys(c)) {
                        ...
                        if (!a || t.includes(r)) {
                            const t = c[n];
                            O(e, l, s, t.callable, t.delegationSelector);
                        }
                    }
                } else {
            ...
            trigger(e, t, n) {
                ...
                let i = null,
                    ...
                    s = !0,
                    a = !1;
                t !== P(t) && r && ((i = r.Event(t, n)), r(e).trigger(i), (o = !i.isPropagationStopped()), (s = !i.isImmediatePropagationStopped()), (a = i.isDefaultPrevented()));
                let l = new Event(t, { bubbles: o, cancelable: !0 });
                return (l = R(l, n)), a && l.preventDefault(), s && e.dispatchEvent(l), l.defaultPrevented && i && i.preventDefault(), l;
            },
        };
        function R(e, t) {
        ...
        const B = {
            ...
            getDataAttributes(e) {
                ...
                for (const r of n) {
                    let n = r.replace(/^bs/, "");
                    (n = n.charAt(0).toLowerCase() + n.slice(1, n.length)), (t[n] = q(e.dataset[r]));
                }
                return t;
            },
        ...
        class $ {
            ...
            _mergeConfigObj(e, t) {
                const n = a(t) ? B.getDataAttribute(t, "config") : {};
                return { ...this.constructor.Default, ...("object" == typeof n ? n : {}), ...(a(t) ? B.getDataAttributes(t) : {}), ...("object" == typeof e ? e : {}) };
            }
        ...
        class z extends $ {
            constructor(e, t) {
                super(), (e = l(e)) && ((this._element = e), (this._config = this._getConfig(t)), M.set(this._element, this.constructor.DATA_KEY, this));
            }
            dispose() {
                M.remove(this._element, this.constructor.DATA_KEY), F.off(this._element, this.constructor.EVENT_KEY);
            ...
            static getInstance(e) {
                return M.get(l(e), this.DATA_KEY);
            }
        ...
        F.on(document, "click.bs.button.data-api", X, (e) => {
            e.preventDefault();
        ...
        const Y = {
            ...
            Q = { endCallback: null, leftCallback: null, rightCallback: null },
        ...
        class K extends $ {
            ...
            _initEvents() {
                this._supportPointerEvents
                    ? (F.on(this._element, "pointerdown.bs.swipe", (e) => this._start(e)), F.on(this._element, "pointerup.bs.swipe", (e) => this._end(e)), this._element.classList.add("pointer-event"))
                    : (F.on(this._element, "touchstart.bs.swipe", (e) => this._start(e)), F.on(this._element, "touchmove.bs.swipe", (e) => this._move(e)), F.on(this._element, "touchend.bs.swipe", (e) => this._end(e)));
            }
        ...
        const Z = "next",
            ...
            ae = { interval: 5e3, keyboard: !0, pause: "hover", ride: !1, touch: !0, wrap: !0 },
        ...
        class ce extends z {
            ...
            _maybeEnableCycle() {
                this._config.ride && (this._isSliding ? F.one(this._element, re, () => this.cycle()) : this.cycle());
            }
            to(e) {
                const t = this._getItems();
                if (e > t.length - 1 || e < 0) return;
                if (this._isSliding) return void F.one(this._element, re, () => this.to(e));
            ...
            _addTouchEventListeners() {
                for (const e of Y.find(".carousel-item img", this._element)) F.on(e, "dragstart.bs.carousel", (e) => e.preventDefault());
                const e = {
            ...
            _setActiveIndicatorElement(e) {
                ...
                n && (n.classList.add(oe), n.setAttribute("aria-current", "true"));
            }
            _updateInterval() {
            ...
            _slide(e, t = null) {
                ...
                const o = this._getItemIndex(i),
                    s = (t) => F.trigger(this._element, t, { relatedTarget: i, direction: this._orderToDirection(e), from: this._getItemIndex(n), to: o });
                ...
                i.classList.add(c),
                    ...
                    this._queueCallback(
                        () => {
                            i.classList.remove(l, c), i.classList.add(oe), n.classList.remove(oe, c, l), (this._isSliding = !1), s(re);
                        },
                        n,
                        this._isAnimated()
                    ),
            ...
            _directionToOrder(e) {
                return m() ? (e === te ? ee : Z) : e === te ? Z : ee;
            }
            _orderToDirection(e) {
                return m() ? (e === ee ? te : ne) : e === ee ? ne : te;
            }
            static jQueryInterface(e) {
                return this.each(function () {
        ...
        F.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", function (e) {
            ...
            return r ? (n.to(r), void n._maybeEnableCycle()) : "next" === B.getDataAttribute(this, "slide") ? (n.next(), void n._maybeEnableCycle()) : (n.prev(), void n._maybeEnableCycle());
        }),
        ...
        const ue = "show",
            ...
            ge = { parent: "(null|element)", toggle: "boolean" };
        class me extends z {
            constructor(e, t) {
                ...
                for (const e of n) {
                    const t = i(e),
                        n = Y.find(t).filter((e) => e === this._element);
            ...
            show() {
                ...
                this._element.classList.remove(fe), this._element.classList.add(de), (this._element.style[t] = 0), this._addAriaAndCollapsedClass(this._triggerArray, !0), (this._isTransitioning = !0);
                const n = `scroll${t[0].toUpperCase() + t.slice(1)}`;
                this._queueCallback(
                    () => {
                        (this._isTransitioning = !1), this._element.classList.remove(de), this._element.classList.add(fe, ue), (this._element.style[t] = ""), F.trigger(this._element, "shown.bs.collapse");
                    },
                    this._element,
                    !0
                ),
            ...
            hide() {
                ...
                (this._element.style[e] = `${this._element.getBoundingClientRect()[e]}px`), h(this._element), this._element.classList.add(de), this._element.classList.remove(fe, ue);
                ...
                (this._isTransitioning = !0),
                    ...
                    this._queueCallback(
                        () => {
                            (this._isTransitioning = !1), this._element.classList.remove(de), this._element.classList.add(fe), F.trigger(this._element, "hidden.bs.collapse");
                        },
                        this._element,
                        !0
                    );
        ...
        F.on(document, "click.bs.collapse.data-api", he, function (e) {
            ("A" === e.target.tagName || (e.delegateTarget && "A" === e.delegateTarget.tagName)) && e.preventDefault();
            const t = i(this),
                n = Y.find(t);
            for (const e of n) me.getOrCreateInstance(e, { toggle: !1 }).toggle();
        }),
            v(me);
        const ve = "dropdown",
            ye = "ArrowUp",
            be = "ArrowDown",
            _e = "click.bs.dropdown.data-api",
            we = "keydown.bs.dropdown.data-api",
            xe = "show",
            Se = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',
            Te = `${Se}.show`,
            Ce = ".dropdown-menu",
            De = m() ? "top-end" : "top-start",
            Ae = m() ? "top-start" : "top-end",
            Ee = m() ? "bottom-end" : "bottom-start",
            ke = m() ? "bottom-start" : "bottom-end",
            Le = m() ? "left-start" : "right-start",
            Ie = m() ? "right-start" : "left-start",
            je = { autoClose: !0, boundary: "clippingParents", display: "dynamic", offset: [0, 2], popperConfig: null, reference: "toggle" },
            Oe = { autoClose: "(boolean|string)", boundary: "(string|element)", display: "string", offset: "(array|string|function)", popperConfig: "(null|object|function)", reference: "(string|element|object)" };
        class Ne extends z {
            constructor(e, t) {
                super(e, t),
                    (this._popper = null),
                    (this._parent = this._element.parentNode),
                    (this._menu = Y.next(this._element, Ce)[0] || Y.prev(this._element, Ce)[0] || Y.findOne(Ce, this._parent)),
            ...
            show() {
                ...
                if (!F.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
                    if ((this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav"))) for (const e of [].concat(...document.body.children)) F.on(e, "mouseover", d);
                    this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(xe), this._element.classList.add(xe), F.trigger(this._element, "shown.bs.dropdown", e);
                }
            }
            hide() {
                if (u(this._element) || !this._isShown()) return;
            ...
            _completeHide(e) {
                if (!F.trigger(this._element, "hide.bs.dropdown", e).defaultPrevented) {
                    if ("ontouchstart" in document.documentElement) for (const e of [].concat(...document.body.children)) F.off(e, "mouseover", d);
            ...
            _getPlacement() {
                ...
                if (e.classList.contains("dropstart")) return Ie;
                if (e.classList.contains("dropup-center")) return "top";
                if (e.classList.contains("dropdown-center")) return "bottom";
                const t = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim();
                return e.classList.contains("dropup") ? (t ? Ae : De) : t ? ke : Ee;
            }
            _detectNavbar() {
            ...
            _getPopperConfig() {
                ...
                return (
                    (this._inNavbar || "static" === this._config.display) && (B.setDataAttribute(this._menu, "popper", "static"), (e.modifiers = [{ name: "applyStyles", enabled: !1 }])),
            ...
            _selectMenuItem({ key: e, target: t }) {
                ...
                n.length && _(n, t, e === be, !n.includes(t)).focus();
            }
            static jQueryInterface(e) {
                return this.each(function () {
            ...
            static dataApiKeydownHandler(e) {
                const t = /input|textarea/i.test(e.target.tagName),
                    n = "Escape" === e.key,
                    r = [ye, be].includes(e.key);
                if (!r && !n) return;
                if (t && !n) return;
                e.preventDefault();
                const i = this.matches(Se) ? this : Y.prev(this, Se)[0] || Y.next(this, Se)[0] || Y.findOne(Se, e.delegateTarget.parentNode),
                    o = Ne.getOrCreateInstance(i);
                if (r) return e.stopPropagation(), o.show(), void o._selectMenuItem(e);
                o._isShown() && (e.stopPropagation(), o.hide(), i.focus());
            }
        }
        F.on(document, we, Se, Ne.dataApiKeydownHandler),
            F.on(document, we, Ce, Ne.dataApiKeydownHandler),
            F.on(document, _e, Ne.clearMenus),
            F.on(document, "keyup.bs.dropdown.data-api", Ne.clearMenus),
            F.on(document, _e, Se, function (e) {
                e.preventDefault(), Ne.getOrCreateInstance(this).toggle();
            }),
            v(Ne);
        const Pe = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
            Fe = ".sticky-top",
            Re = "padding-right",
            He = "margin-right";
        class Me {
            ...
            hide() {
                ...
                this._disableOverFlow(), this._setElementAttributes(this._element, Re, (t) => t + e), this._setElementAttributes(Pe, Re, (t) => t + e), this._setElementAttributes(Fe, He, (t) => t - e);
            }
            reset() {
                this._resetElementAttributes(this._element, "overflow"), this._resetElementAttributes(this._element, Re), this._resetElementAttributes(Pe, Re), this._resetElementAttributes(Fe, He);
            }
            isOverflowing() {
            ...
            _resetElementAttributes(e, t) {
                this._applyManipulationCallback(e, (e) => {
                    ...
                    null !== n ? (B.removeDataAttribute(e, t), e.style.setProperty(t, n)) : e.style.removeProperty(t);
                });
            }
            _applyManipulationCallback(e, t) {
                if (a(e)) t(e);
                else for (const n of Y.find(e, this._element)) t(n);
            }
        }
        const qe = "show",
            We = "mousedown.bs.backdrop",
            Be = { className: "modal-backdrop", clickCallback: null, isAnimated: !1, isVisible: !0, rootElement: "body" },
            $e = { className: "string", clickCallback: "(function|null)", isAnimated: "boolean", isVisible: "boolean", rootElement: "(element|string)" };
        class ze extends $ {
            constructor(e) {
            ...
            hide(e) {
                this._config.isVisible
                    ? (this._getElement().classList.remove(qe),
                      this._emulateAnimation(() => {
                          this.dispose(), y(e);
                      }))
                    : y(e);
        ...
        class Ye extends $ {
            ...
            deactivate() {
                this._isActive && ((this._isActive = !1), F.off(document, Ue));
            }
            _handleFocusin(e) {
        ...
        class rt extends z {
            ...
            show(e) {
                this._isShown ||
                    ...
                    F.trigger(this._element, Ge, { relatedTarget: e }).defaultPrevented ||
                    ((this._isShown = !0), (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(Ke), this._adjustDialog(), this._backdrop.show(() => this._showElement(e)));
            }
            hide() {
                this._isShown &&
                    !this._isTransitioning &&
                    (F.trigger(this._element, "hide.bs.modal").defaultPrevented ||
                        ((this._isShown = !1), (this._isTransitioning = !0), this._focustrap.deactivate(), this._element.classList.remove(Ze), this._queueCallback(() => this._hideModal(), this._element, this._isAnimated())));
            }
            dispose() {
            ...
            _initializeBackDrop() {
                return new ze({ isVisible: Boolean(this._config.backdrop), isAnimated: this._isAnimated() });
            }
            ...
            _hideModal() {
                (this._element.style.display = "none"),
                    ...
                    (this._isTransitioning = !1),
                    this._backdrop.hide(() => {
                        document.body.classList.remove(Ke), this._resetAdjustments(), this._scrollBar.reset(), F.trigger(this._element, Qe);
                    });
            }
            _isAnimated() {
        ...
        F.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', function (e) {
            ...
            n && rt.getInstance(n).hide(), rt.getOrCreateInstance(t).toggle(this);
        }),
            U(rt),
            v(rt);
        const it = "show",
            ...
            ut = { backdrop: !0, keyboard: !0, scroll: !1 },
            ft = { backdrop: "(boolean|string)", keyboard: "boolean", scroll: "boolean" };
        class dt extends z {
            constructor(e, t) {
                    ...
                    this._queueCallback(
                        () => {
                            (this._config.scroll && !this._config.backdrop) || this._focustrap.activate(),
                                ...
                                F.trigger(this._element, "shown.bs.offcanvas", { relatedTarget: e });
                        },
                        this._element,
                        !0
                    ));
            ...
            hide() {
                this._isShown &&
                    (F.trigger(this._element, "hide.bs.offcanvas").defaultPrevented ||
                        ...
                        this._queueCallback(
                            () => {
                                this._element.classList.remove(it, st), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._config.scroll || new Me().reset(), F.trigger(this._element, ct);
                            },
                            this._element,
                            !0
                        )));
            ...
            _initializeBackDrop() {
                ...
                return new ze({
                    ...
                    clickCallback: e
                        ? () => {
                              "static" !== this._config.backdrop ? this.hide() : F.trigger(this._element, lt);
                          }
                        : null,
                });
            }
            ...
            _addEventListeners() {
                F.on(this._element, "keydown.dismiss.bs.offcanvas", (e) => {
                    "Escape" === e.key && (this._config.keyboard ? this.hide() : F.trigger(this._element, lt));
                });
            }
            static jQueryInterface(e) {
                return this.each(function () {
        ...
        F.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function (e) {
            ...
            const n = Y.findOne(at);
            n && n !== t && dt.getInstance(n).hide(), dt.getOrCreateInstance(t).toggle(this);
        }),
            F.on(window, "load.bs.offcanvas.data-api", () => {
                for (const e of Y.find(at)) dt.getOrCreateInstance(e).show();
            }),
            F.on(window, "resize.bs.offcanvas", () => {
                for (const e of Y.find("[aria-modal][class*=show][class*=offcanvas-]")) "fixed" !== getComputedStyle(e).position && dt.getOrCreateInstance(e).hide();
            }),
            U(dt),
            v(dt);
        const ht = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
            pt = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i,
            gt = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i,
            mt = (e, t) => {
                const n = e.nodeName.toLowerCase();
                return t.includes(n) ? !ht.has(n) || Boolean(pt.test(e.nodeValue) || gt.test(e.nodeValue)) : t.filter((e) => e instanceof RegExp).some((e) => e.test(n));
            },
            vt = {
            ...
            yt = { allowList: vt, content: {}, extraClass: "", html: !1, sanitize: !0, sanitizeFn: null, template: "<div></div>" },
            bt = { allowList: "object", content: "object", extraClass: "(string|function)", html: "boolean", sanitize: "boolean", sanitizeFn: "(null|function)", template: "string" },
            _t = { entry: "(string|element|function|null)", selector: "(string|element)" };
        class wt extends $ {
            constructor(e) {
            ...
            _checkContent(e) {
                for (const [t, n] of Object.entries(e)) super._typeCheckConfig({ selector: t, entry: n }, _t);
            }
            _setContent(e, t, n) {
                const r = Y.findOne(n, e);
                    ...
                    ? (function (e, t, n) {
                          ...
                          for (const e of i) {
                              ...
                              const r = [].concat(...e.attributes),
                                  i = [].concat(t["*"] || [], t[n] || []);
                              for (const t of r) mt(t, i) || e.removeAttribute(t.nodeName);
                          }
        ...
        const xt = new Set(["sanitize", "allowList", "sanitizeFn"]),
            ...
            At = "hover",
            Et = "focus",
            kt = { AUTO: "auto", TOP: "top", RIGHT: m() ? "left" : "right", BOTTOM: "bottom", LEFT: m() ? "right" : "left" },
            Lt = {
                allowList: vt,
                animation: !0,
        ...
        class jt extends z {
            ...
            dispose() {
                clearTimeout(this._timeout),
                    F.off(this._element.closest(Ct), Dt, this._hideModalHandler),
            ...
            show() {
                ...
                if (
                    (this._element.ownerDocument.documentElement.contains(this.tip) || (r.append(n), F.trigger(this._element, this.constructor.eventName("inserted"))),
                    (this._popper = this._createPopper(n)),
                    n.classList.add(Tt),
                    "ontouchstart" in document.documentElement)
                )
                    for (const e of [].concat(...document.body.children)) F.on(e, "mouseover", d);
                this._queueCallback(
                    () => {
            ...
            hide() {
                if (this._isShown() && !F.trigger(this._element, this.constructor.eventName("hide")).defaultPrevented) {
                    if ((this._getTipElement().classList.remove(Tt), "ontouchstart" in document.documentElement)) for (const e of [].concat(...document.body.children)) F.off(e, "mouseover", d);
            ...
            _createTipElement(e) {
                ...
                if (!t) return null;
                t.classList.remove(St, Tt), t.classList.add(`bs-${this.constructor.NAME}-auto`);
                const n = ((e) => {
                    do {
                ...
                return t.setAttribute("id", n), this._isAnimated() && t.classList.add(St), t;
            }
            setContent(e) {
            ...
            _getTemplateFactory(e) {
                return (
                    this._templateFactory ? this._templateFactory.changeContent(e) : (this._templateFactory = new wt({ ...this._config, content: e, extraClass: this._resolvePossibleFunction(this._config.customClass) })),
            ...
            _setListeners() {
                ...
                for (const t of e)
                    if ("click" === t)
                        ...
                        const e = t === At ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"),
                            n = t === At ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout");
                        F.on(this._element, e, this._config.selector, (e) => {
                            const t = this._initializeOnDelegatedTarget(e);
                            (t._activeTrigger["focusin" === e.type ? Et : At] = !0), t._enter();
                        }),
                            F.on(this._element, n, this._config.selector, (e) => {
                                const t = this._initializeOnDelegatedTarget(e);
                                (t._activeTrigger["focusout" === e.type ? Et : At] = t._element.contains(e.relatedTarget)), t._leave();
                            });
                    }
                (this._hideModalHandler = () => {
                    this._element && this.hide();
                }),
                    F.on(this._element.closest(Ct), Dt, this._hideModalHandler);
            }
            _fixTitle() {
            ...
            _getConfig(e) {
                ...
                for (const e of Object.keys(t)) xt.has(e) && delete t[e];
        ...
        const Ot = {
            ...
            Nt = { ...jt.DefaultType, content: "(null|string|element|function)" };
        class Pt extends jt {
            static get Default() {
                return Ot;
            }
        ...
        v(Pt);
        const Ft = "click.bs.scrollspy",
            Rt = "active",
            Ht = "[href]",
            Mt = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: !1, target: null, threshold: [0.1, 0.5, 1] },
            qt = { offset: "(number|null)", rootMargin: "string", smoothScroll: "boolean", target: "element", threshold: "array" };
        class Wt extends z {
            constructor(e, t) {
                super(e, t),
            ...
            _configAfterMerge(e) {
                return (
                    (e.target = l(e.target) || document.body), (e.rootMargin = e.offset ? `${e.offset}px 0px -30%` : e.rootMargin), "string" == typeof e.threshold && (e.threshold = e.threshold.split(",").map((e) => Number.parseFloat(e))), e
                );
            }
            _maybeEnableSmoothScroll() {
                this._config.smoothScroll &&
                    (F.off(this._config.target, Ft),
                    F.on(this._config.target, Ft, Ht, (e) => {
            ...
            _initializeTargetsAndObservables() {
                ...
                const e = Y.find(Ht, this._config.target);
                for (const t of e) {
            ...
            _process(e) {
                this._activeTarget !== e && (this._clearActiveClass(this._config.target), (this._activeTarget = e), e.classList.add(Rt), this._activateParents(e), F.trigger(this._element, "activate.bs.scrollspy", { relatedTarget: e }));
            }
            _activateParents(e) {
                if (e.classList.contains("dropdown-item")) Y.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(Rt);
                else for (const t of Y.parents(e, ".nav, .list-group")) for (const e of Y.prev(t, ".nav-link, .nav-item > .nav-link, .list-group-item")) e.classList.add(Rt);
            }
            _clearActiveClass(e) {
                e.classList.remove(Rt);
                const t = Y.find("[href].active", e);
                for (const e of t) e.classList.remove(Rt);
            }
            static jQueryInterface(e) {
                return this.each(function () {
        ...
        F.on(window, "load.bs.scrollspy.data-api", () => {
            for (const e of Y.find('[data-bs-spy="scroll"]')) Wt.getOrCreateInstance(e);
        }),
            v(Wt);
        const Bt = "ArrowLeft",
            $t = "ArrowRight",
            ...
            Qt = `.nav-link:not(.dropdown-toggle), .list-group-item:not(.dropdown-toggle), [role="tab"]:not(.dropdown-toggle), ${Yt}`;
        class Gt extends z {
            constructor(e) {
                super(e),
                    (this._parent = this._element.closest('.list-group, .nav, [role="tablist"]')),
                    this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), F.on(this._element, "keydown.bs.tab", (e) => this._keydown(e)));
            }
            static get NAME() {
                return "tab";
            }
            show() {
                ...
                const t = this._getActiveElem(),
                    n = t ? F.trigger(t, "hide.bs.tab", { relatedTarget: e }) : null;
                F.trigger(e, "show.bs.tab", { relatedTarget: t }).defaultPrevented || (n && n.defaultPrevented) || (this._deactivate(t, e), this._activate(e, t));
            }
            _activate(e, t) {
                e &&
                    (e.classList.add(Vt),
                    ...
                    this._queueCallback(
                        () => {
                            "tab" === e.getAttribute("role") ? (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), F.trigger(e, "shown.bs.tab", { relatedTarget: t })) : e.classList.add(Jt);
                        },
                        e,
            ...
            _deactivate(e, t) {
                e &&
                    ...
                    e.blur(),
                    this._deactivate(o(e)),
                    this._queueCallback(
                        () => {
                            "tab" === e.getAttribute("role")
                                ? (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), this._toggleDropDown(e, !1), F.trigger(e, "hidden.bs.tab", { relatedTarget: t }))
            ...
            _keydown(e) {
                if (![Bt, $t, zt, Ut].includes(e.key)) return;
                e.stopPropagation(), e.preventDefault();
                const t = [$t, Ut].includes(e.key),
                    n = _(
                        this._getChildren().filter((e) => !u(e)),
                        e.target,
                        t,
                        !0
                    );
                n && (n.focus({ preventScroll: !0 }), Gt.getOrCreateInstance(n).show());
            }
            _getChildren() {
                return Y.find(Qt, this._parent);
            }
            _getActiveElem() {
            ...
            _toggleDropDown(e, t) {
                ...
                const r = (e, r) => {
                    const i = Y.findOne(e, n);
                    i && i.classList.toggle(r, t);
                };
                r(".dropdown-toggle", Vt), r(".dropdown-menu", Jt), n.setAttribute("aria-expanded", t);
            }
            ...
            _getInnerElement(e) {
                return e.matches(Qt) ? e : Y.findOne(Qt, e);
            }
            _getOuterElement(e) {
        ...
        F.on(document, "click.bs.tab", Yt, function (e) {
            ["A", "AREA"].includes(this.tagName) && e.preventDefault(), u(this) || Gt.getOrCreateInstance(this).show();
        }),
            F.on(window, "load.bs.tab", () => {
                for (const e of Y.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]')) Gt.getOrCreateInstance(e);
            }),
            v(Gt);
        const Kt = "hide",
            Zt = "show",
        ...
        class rn extends z {
            ...
            show() {
                F.trigger(this._element, "show.bs.toast").defaultPrevented ||
                    ...
                    this._queueCallback(
                        () => {
                            this._element.classList.remove(en), F.trigger(this._element, "shown.bs.toast"), this._maybeScheduleHide();
                        },
                        this._element,
            ...
            hide() {
                this.isShown() &&
                    (F.trigger(this._element, "hide.bs.toast").defaultPrevented ||
                        ...
                        this._queueCallback(
                            () => {
                                this._element.classList.add(Kt), this._element.classList.remove(en, Zt), F.trigger(this._element, "hidden.bs.toast");
                            },
                            this._element,
                            this._config.animation
                        )));
        ...
        return U(rn), v(rn), { Alert: V, Button: J, Carousel: ce, Collapse: me, Dropdown: Ne, Modal: rt, Offcanvas: dt, Popover: Pt, ScrollSpy: Wt, Tab: Gt, Toast: rn, Tooltip: jt };
    }),
    (function (e) {
        "function" == typeof define && define.amd
            ...
            : "object" == typeof exports
            ? (module.exports = function (t, n) {
                  return (t = t || window), (n = n || ("undefined" != typeof window ? require("jquery") : require("jquery")(t))).fn.dataTable || require("datatables.net")(t, n), e(n, 0, t.document);
              })
        ...
        return (
            e.extend(!0, i.defaults, { dom: "<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row dt-row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>", renderer: "bootstrap" }),
            ...
            (i.ext.renderer.pageButton.bootstrap = function (t, o, s, a, l, c) {
                ...
                o = e(o);
                try {
                    d = o.find(n.activeElement).data("dt-idx");
                } catch (o) {}
                ...
                v.length ? v.empty() : (v = o.html("<ul/>").children("ul").addClass("pagination")),
                    (function n(r, i) {
                        for (
                            ...
                            if (((a = i[v]), Array.isArray(a))) n(r, a);
                            else {
                                switch (((f = u = ""), a)) {
                                    case "ellipsis":
                                        (u = "&#x2026;"), (f = "disabled");
                                        break;
                                    case "first":
                                        (u = g.sFirst), (f = a + (0 < l ? "" : " disabled"));
                                        break;
                                    case "previous":
                                        (u = g.sPrevious), (f = a + (0 < l ? "" : " disabled"));
                                        break;
                                    case "next":
                                        (u = g.sNext), (f = a + (l < c - 1 ? "" : " disabled"));
                                        break;
                                    case "last":
                                        (u = g.sLast), (f = a + (l < c - 1 ? "" : " disabled"));
                                        break;
                                    default:
                                        (u = a + 1), (f = l === a ? "active" : "");
                                }
                                u &&
                                    ((o = e("<li>", { class: p.sPageButton + " " + f, id: 0 === s && "string" == typeof a ? t.sTableId + "_" + a : null })
                                        .append(e("<a>", { href: "#", "aria-controls": t.sTableId, "aria-label": m[a], "data-dt-idx": a, tabindex: t.iTabIndex, class: "page-link" }).html(u))
                                        .appendTo(r)),
                                    t.oApi._fnBindAction(o, { action: a }, d));
                            }
                    })(v, a),
                    d !== r && o.find("[data-dt-idx=" + d + "]").trigger("focus");
            }),
            i
        );
    }),
    ...
    (function () {
        ...
        function t(e) {
            (this.element = e),
                ...
                (n += 1),
                i.windowContext || ((i.windowContext = !0), (i.windowContext = new t(window))),
                ...
                (e = {
                    ...
                    for (var a in this.waypoints[o]) {
                        var l,
                            ...
                            g = 0,
                            m = null == p;
                        d.element !== d.element.window && (g = d.adapter.offset()[s.offsetProp]),
                            ...
                            (d.triggerPoint = Math.floor(g + l - h)),
                            (c = p < s.oldScroll),
                            (u = d.triggerPoint >= s.oldScroll),
                            (f = !c && !u),
                            !m && c && u ? (d.queueTrigger(s.backward), (r[d.group.id] = d.group)) : ((!m && f) || (m && s.oldScroll >= d.triggerPoint)) && (d.queueTrigger(s.forward), (r[d.group.id] = d.group));
                    }
                }
                return (
        ...
        (n.prototype.innerHeight = function () {
            ...
            (n.prototype.off = function (e, t) {
                ...
                var r = e.split("."),
                    ...
                    o = r[1],
                    s = this.element;
                if (o && this.handlers[o] && i) n(s, this.handlers[o][i], t), (this.handlers[o][i] = []);
                else if (i) for (var a in this.handlers) n(s, this.handlers[a][i] || [], t), (this.handlers[a][i] = []);
            ...
            (n.prototype.offset = function () {
                ...
                var e = this.element.ownerDocument.documentElement,
                    ...
                    r = { top: 0, left: 0 };
                return this.element.getBoundingClientRect && (r = this.element.getBoundingClientRect()), { top: r.top + n.pageYOffset - e.clientTop, left: r.left + n.pageXOffset - e.clientLeft };
            }),
            ...
            r.adapters.push({ name: "noframework", Adapter: n }),
            (r.Adapter = n);
    })();
