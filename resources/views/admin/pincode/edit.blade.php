                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="{{url('pincode')}}" class="btn btn-link btn-soft-light">
...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
        ...
        <form action="{{url('pincode/pincodeupdate/'.$list[0]->pinid)}}"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-md-6 mt-3" >
                <label class="form-label" for="price">Pincode</label>
                <input type="text" class="form-control" name="pincode" value="{{$list[0]->pincode}}" placeholder="Enter Pincode" required>
