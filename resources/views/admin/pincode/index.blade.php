            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('pincode/create_pincode')}}" class="btn btn-link btn-soft-light">
                  ...
                  <tbody>
                    ...
                    @foreach ($list as $item)
                     <tr>
                        ...
                        <td>
                            <a href="{{url('pincode/edit/'.$item->pinid)}}"> 
                            ...
                            <a href="{{url('pincode/delete/'.$item->pinid)}}"  onclick="return confirm('Are you sure to Delete Permanently?')"> 
