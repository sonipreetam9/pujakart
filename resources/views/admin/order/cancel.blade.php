                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn btn-success btn-sm">{{"Cancel Accepted"}}</div>
                                        @endif
                                        @if($item->status_order==55)
                                        <div class="btn btn-success btn-sm">{{"Cancel Requested"}}</div>
                                        @endif
                                        @if($item->status_order==555)
                                        <div class="btn btn-danger btn-sm">{{"Order Canceled"}}</div>
                                        @endif
                                    ...
                                    <td>
                                        <a href="{{url('order/cancel_edit/'.$item->order_id)}}"> 
