            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        <div>
                            <h1>Update Return Orders</h1>
                        </div>
                        <div>
                            <a href="{{url('order/return')}}" class="btn btn-link btn-soft-light">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                <form action="{{url('order/returnupdate/'.$list[0]->order_id)}}"  method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-12 mt-3" >
                        <label class="form-label" for="price">Return Order </label>
                        <select name="status_order" required class="form-control">
                            <option value="">--Select Status--</option>
                            <option @if($list[0]->status_order=='6') selected @endif value="6">Accept</option>
                            <option @if($list[0]->status_order=='666') selected @endif value="666">Cancel</option>
                        </select>
                    </div>
