            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">View Exchange Orders</h4>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn btn-success btn-sm">{{"Exchange Accepted"}}</div>
                                        @endif
                                        @if($item->status_order==77)
                                        <div class="btn btn-success btn-sm">{{"Exchange Requested"}}</div>
                                        @endif
                                        @if($item->status_order==777)
                                        <div class="btn btn-danger btn-sm">{{"Exchange Canceled"}}</div>
                                        @endif
                                    </td>
                                    <td> 
                                    ...
                                    <td>
                                        <a href="{{url('order/exchange_edit/'.$item->order_id)}}"> 
