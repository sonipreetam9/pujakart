            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('order/exchange')}}" class="btn btn-link btn-soft-light">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Exchange Orders</h4>
                    </div>
                </div>
            
                <div class="card-body">
                <form action="{{url('order/exchangeupdate/'.$list[0]->order_id)}}"  method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-12 mt-3" >
                        <label class="form-label" for="price">Exchange Order </label>
                        <select name="status_order" required class="form-control">
                            <option value="">--Select Status--</option>
                            <option @if($list[0]->status_order=='7') selected @endif value="7">Accept</option>
                            <option @if($list[0]->status_order=='777') selected @endif value="777">Cancel</option>
                        </select>
                    </div>
