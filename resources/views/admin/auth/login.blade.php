...
<head>
    <meta charset="utf-8">
      ...
      <title>Pujakart</title>
      <meta name="description" content="">
      <meta name="keywords" content="">
      <meta name="author" content="AmazingWeb.Design">
      <meta name="DC.title" content="Poly Connect">
      <!-- Favicon -->
      <!--https://templates.iqonic.design/product/qompac-ui/html/dist/assets/images/favicon.ico-->
      ...
      <section class="login-content overflow-hidden">
         <div class="row no-gutters align-items-center bg-white">            
            <div class="col-md-12 col-lg-6 align-self-center">
               <a href="javascript:void(0)" class="navbar-brand d-flex align-items-center mb-3 justify-content-center text-primary">
                  <div class="logo-normal">
                     ...
                     <center><img src="{{url('assets/images/pujakart.jpeg')}}" style="width:40%;border-radius:4px;" alt="Pujan Samagri"></center>
                  </div>
                  <!-- <h2 class="logo-title ms-3 mb-0" style="font-weight: bold; font-size: 35px;  text-shadow: 1px 1px 0 #000;">PUJAN SAMAGRI</h2> -->
               </a>
