            ...
            <div class="row">
                 <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('supercategory')}}" class="btn btn-link btn-soft-light">
...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
            <form action="{{url('supercategory/catupdate/'.$list[0]->cid)}}"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <!--{{asset('bankImage/'.$list[0]->logo)}}-->
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">Category Name</label>
                    <input type="text" class="form-control" name="cat_name" value="{{$list[0]->cat_name}}" placeholder="Cat Name" required>
                    @if($errors->has('cat_name'))
                        <div class="form-error">{{ $errors->first('cat_name') }}</div>
                    @endif
                </div>
                <div class="col-md-6 mt-3" >
