                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{url('books/create_books')}}" class="btn btn-link btn-soft-light">
               ...
               <table id="datatable" class="table " data-toggle="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>#{{$i}}</td>
                        @php($i++)
                        <td><img src="bookImage/{{$item->bookimage}}" alt="" style="width:80px;"></td>
                        <td>{{$item->book_name}}</td>
                        <td><b>{{$item->bcname}}</b> </td>
                        ...
                        <td>
                            <a href="{{url('books/edit/'.$item->bid)}}"> 
                            ...
                            <a href="{{url('books/delete/'.$item->bid)}}" onclick="return confirm('Are you sure to Delete Permanently?')"> 
