            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('shipping/create_charges')}}" class="btn btn-link btn-soft-light">
      ...
      <div class="card">
         <div class="card-header d-flex justify-content-between">
            <div class="header-title">
               <h4 class="card-title">View  Shipping</h4>
            </div>
         </div>
         <div class="card-body">
               ...
               <table id="datatable" class="table " data-toggle="data-table">
                  ...
                  <tbody>
                    ...
                    @foreach ($list as $item)
                     <tr>
                        <td>#{{$i}}</td>
                        <td>{{$item->shipping_min_amount}}</td>
                        <td>{{$item->charges}}</td>
                        <td>
                            ...
                            <a href="{{url('shipping/delete/'.$item->ship_id)}}" onclick="return confirm('Are you sure to Delete Permanently?')"> 
