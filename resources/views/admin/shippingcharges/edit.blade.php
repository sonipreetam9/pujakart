        ...
        <div class="row">
           <div class="col-sm-12">
              <div class="card">
                ...
                <div class="card-body">
                    <form action="{{url('shipping/shippingupdate/'.$list[0]->ship_id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mt-3" >
                                <label class="form-label" for="price">Shipping Amount</label>
                                <input type="number" class="form-control" name="shipping_min_amount" value="{{$list[0]->shipping_min_amount}}" placeholder="Shipping Amount" required>
                            </div>
                            <div class="col-md-6 mt-3" >
                                <label class="form-label" for="price">Charges</label>
                                <input type="number" class="form-control" name="charges" value="{{$list[0]->charges}}" placeholder="Enter unit name" required>
                            </div>
                            <div class="col-md-6 mt-3">
