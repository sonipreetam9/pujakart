            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                        <a href="{{url('shipping_charges')}}" class="btn btn-link btn-soft-light">
...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
        <form action="{{url('shipping/shippingsave')}}"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12 mt-3" >
                    <label class="form-label" for="unit">Shipping Amount</label>
                    <input type="number" class="form-control" name="shipping_min_amount"  placeholder="Shipping Amount" required>
                    @if($errors->has('shipping_min_amount'))
                        <div class="form-error">{{ $errors->first('shipping_min_amount') }}</div>
                    @endif
                </div>
                <div class="col-md-12 mt-3" >
                    <label class="form-label" for="unit">Charges</label>
                    <input type="number" class="form-control" name="charges" min="0" value="0"  placeholder="Shipping Charges" required>
                    @if($errors->has('charges'))
                        <div class="form-error">{{ $errors->first('charges') }}</div>
                    @endif
                </div>
