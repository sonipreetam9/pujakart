            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('setting/return_exchange')}}" class="btn btn-link btn-soft-light">
...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
        <form action="{{url('setting/returnexchupdate/'.$list[0]->id)}}"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-md-12 mt-3">
                    <label class="form-label" for="price"><b>Change Value</b></label>
                 
                    <input type="text" name="option_value" value="{{$list[0]->option_value}}" class="form-control">
