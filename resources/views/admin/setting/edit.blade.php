            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('setting/general_shipping_condition')}}" class="btn btn-link btn-soft-light">
      ...
      <div class="card">
         <div class="card-header d-flex justify-content-between">
            <div class="header-title">
               <h4 class="card-title">Edit Conditions</h4>
            </div>
        </div>
        <div class="card-body">
        <form action="{{url('setting/settingupdate/'.$list[0]->id)}}"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12 mt-3">
                    <label class="form-label" for="price"><b>Name</b></label>
                    <input type="text"  name="option_name" class="form-control" value="{{$list[0]->option_name}}" readonly>
                </div>
                <div class="col-md-12 mt-3">
                    <label class="form-label" for="price"><b>Conditions</b></label>
                    <textarea  name="option_value" class="ckeditor form-control">{{$list[0]->option_value}}</textarea>
                </div>
