            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        <div>
                             <h1>Edit Min Order</h1>
                        </div>
                        <div>
                            <a href="{{url('setting/minimum_order')}}" class="btn btn-link btn-soft-light">
      ...
      <div class="card">
         <div class="card-header d-flex justify-content-between">
            <div class="header-title">
               <h4 class="card-title">Edit Min Order</h4>
            </div>
        </div>
        <div class="card-body">
        <form action="{{url('setting/minedit/'.$list[0]->id)}}"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-md-12 mt-3">
                    <label class="form-label" for="price"><b>Amount</b></label>
                    <input type="number" name="option_value" value="{{$list[0]->option_value}}" min="0"  class="form-control">
                </div>
