                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="{{url('oembrands/create_oembrands')}}" class="btn btn-link btn-soft-light">
                  ...
                  <tbody>
                    ...
                    @foreach ($list as $item)
                     <tr>
                        ...
                        <td>
                            <a href="{{url('oembrands/edit/'.$item->id)}}"> 
                            ...
                            <a href="{{url('oembrands/delete/'.$item->id)}}"> 
