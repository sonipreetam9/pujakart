                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="{{url('oembrands')}}" class="btn btn-link btn-soft-light">
...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
        <form action="{{url('oembrands/update/'.$list->id)}}"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-md-6 mt-3" >
                <label class="form-label" for="price">OEM Brand Name</label>
                <input type="text" class="form-control" name="oem_brands" value="{{$list->oem_brands}}" placeholder="Oem Brand Name" required>
                @if($errors->has('oem_brands'))
                     <div class="form-error">{{ $errors->first('oem_brands') }}</div>
                @endif
            </div>
            <div class="col-md-6 mt-3" >
