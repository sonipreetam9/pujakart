...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
         ...
         <div class="card-body">
        <form action="{{url('oembrands/save')}}"  method="post" enctype="multipart/form-data">
            @csrf
         <div class="row">
              <div class="col-md-12 mt-3" >
                <label class="form-label" for="price">Brand Name</label>
                <input type="text" class="form-control" name="oem_brands"  placeholder="Brand Name" required>
