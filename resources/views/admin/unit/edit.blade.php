            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('unit')}}" class="btn btn-link btn-soft-light">
...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
        ...
        <form action="{{url('unit/unitupdate/'.$list[0]->uid)}}"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-md-6 mt-3" >
                <label class="form-label" for="price">Unit</label>
                <input type="text" class="form-control" name="unit_name" value="{{$list[0]->unit_name}}" placeholder="Enter unit name" required>
                @if($errors->has('unit_name'))
                    <div class="form-error">{{ $errors->first('unit_name') }}</div>
                @endif
            </div>
            <div class="col-md-6 mt-3" >
