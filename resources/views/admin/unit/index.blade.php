            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('unit/create_unit')}}" class="btn btn-link btn-soft-light">
                    ...
                    <div class="table-responsive border rounded">
                       <table id="datatable" class="table " data-toggle="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><i class="fa fa-hashtag" style="font-size:11px;"></i>{{$i}}</td>
                                    @php $i++ @endphp
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('unit/delete/'.$item->uid)}}" onclick="return confirm('Are you sure to Delete Permanently?')"> 
