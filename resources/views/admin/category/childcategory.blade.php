                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            <div>
                                <a href="{{url('maincategory')}}" class="btn btn-link btn-soft-light">
                            ...
                            <div>
                                <a href="{{url('category/createchildcategory/'.$child_id)}}" class="btn btn-link btn-soft-light">
               ...
               <table id="datatable" class="table " data-toggle="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>#{{$i}}</td>
                        @php($i++)
                        <td><img src="{{asset('categoryImage/'.$item->image)}}" alt="" style="width:80px;"></td>
                         <td>{{$crow->cname}}</td>
                        <td>{{$item->cname}}</td>
                        
                        <td><?php if($item->is_parent==0){ echo "<span class='badge bg-success'>Parent</span>";}
                            else{echo "<span class='badge bg-danger'>Child</span>";} ?>
                        </td>
                        ...
                        <td>
                            <a href="{{url('category/childedit/'.$item->sid)}}"> 
                            ...
                            <a href="{{url('category/delete/'.$item->sid)}}"> 
