                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            ...
                            <div>
                            <a href="{{url('category/childcategory/'.$child_id)}}" class="btn btn-link btn-soft-light">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{url('category/childcategorysave')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="file" name="itemimage" class="form-control" required placeholder="Select image">
                                @if($errors->has('itemimage'))
                                    <div class="form-error">{{ $errors->first('itemimage') }}</div>
                                @endif
                            </div>
                            <input type="hidden" name="is_parent" value="{{$child_id}}">
                            <div class="col-md-6 mt-3">
