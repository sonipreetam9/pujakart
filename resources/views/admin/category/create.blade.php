    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{url('category/categorysave')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <select name="is_parent" class="form-control">
                                    ...
                                    @foreach($cat as $row)
                                    <option value="{{$row->sid}}">{{$row->cname}}</option>
                                    @endforeach
                                </select>
                                @if($errors->has('is_parent'))
                                    <div class="form-error">{{ $errors->first('is_parent') }}</div>
                                @endif
                            </div>
                            <div class="col-md-6 mt-3">
