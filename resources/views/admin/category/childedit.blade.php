                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            ...
                            <div>
                            <a href="{{url('category/childcategory/'.$list[0]->is_parent)}}" class="btn btn-link btn-soft-light">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{url('category/childcategorysave/'.$list[0]->sid)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <label class="form-label" for="image">Category Image<span style="color:red;">*</span></label>
                                <input type="file" name="itemimage" class="form-control" placeholder="Select image" style="margin-bottom:5px;">
                                <input type="hidden" name="oldimage" value="{{$list[0]->image}}">
                                <img src="{{asset('categoryImage/'.$list[0]->image)}}" alt="" style="width:80px;">
                                @if($errors->has('itemimage'))
                                    <div class="form-error">{{ $errors->first('itemimage') }}</div>
                                @endif
                            </div>
                            <div class="col-md-6 mt-3">
                                <label class="form-label" for="cname">Category Name<span style="color:red;">*</span></label>
                                <input type="text" class="form-control" name="cname" placeholder="Category Name" value="{{$list[0]->cname}}">
                                @if($errors->has('cname'))
                                    <div class="form-error">{{ $errors->first('cname') }}</div>
                                @endif
                            </div>
                             <div class="col-md-6 mt-3" >
                            ...
                            <input type="hidden" name="is_parent" value="{{$list[0]->is_parent}}">
                            <div class="col-md-6 mt-3">
