    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{url('slider/sliderupdate/'.$list->id)}}"  method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-5 mt-3" >
                                ...
                                <select name="link" class="form-control">
                                    ...
                                    <option value="{{$value->cslug}}" @if($list->link == $value->cslug) selected @endif >{{$value->cname}}</option>
                                    @endforeach
                                </select>
                                @if($errors->has('link'))
                            ...
                            <div class="col-md-5 mt-3" >
                                <label class="form-label" for="price"><b>Slider Image (Width-370px, Height-180px)</b></label>
                                <input type="file" class="form-control" name="itemimage" placeholder="Slider Image" >
                                <input type="hidden" name="oldimage" value="{{$list->image}}">
                            </div>
                            <div class="col-md-2 mt-3" >
                                <img src="{{asset('sliderImage/'.$list->image)}}" alt="" style="height:80px;width:140px;">
                            </div>
