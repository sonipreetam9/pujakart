                  ...
                  <tbody>
                    ...
                    @foreach ($list as $item)
                     <tr>
                        <td>#{{$j}}</td>
                        @php($j++)
                        <td><img src="sliderImage/{{ $item->image }}" alt="" class="img-fluid" style="width:100px;border:2px solid #e9e9e9;border-radius:8px;"> </td>
                        <td>{{$item->cname}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{url('slider/delete/'.$item->id)}}" onclick="return confirm('Are you sure to Delete Permanently?')"> 
