            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('notification/view')}}" class="btn btn-link btn-soft-light">
                    ...
                    <form action="{{url('notification/send')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-3">
                                <label class="form-label" for="cname">Title<span style="color:red;">*</span></label>
                                <textarea name="title" class="form-control" required placeholder="Enter Notification Title"></textarea>
                              
                            </div>
                            <div class="col-md-6 mt-3">
                                <label class="form-label" for="image">Description<span style="color:red;">*</span></label>
