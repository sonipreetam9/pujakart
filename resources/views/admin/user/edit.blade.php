            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('users')}}" class="btn btn-link btn-soft-light">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{url('users/userupdate/'.$list->id)}}"  method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3" >
                                <label class="form-label" for="price">Mobile</label>
                                <input type="text" name="mobile" value="{{ $list->mobile }}" class="form-control">
