        ...
        <form action="{{url('category/categorysave')}}"  method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mt-3" >
                    ...
                    @if($errors->has('catid'))
                        <div class="form-error">{{ $errors->first('catid') }}</div>
                    @endif
                </div>
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">Category Name</label>
                    <input type="text" class="form-control" name="subcat_name"  placeholder="Category Name" required>
                    @if($errors->has('subcat_name'))
                        <div class="form-error">{{ $errors->first('subcat_name') }}</div>
                    @endif
                </div>
