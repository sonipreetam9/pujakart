            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('review')}}" class="btn btn-link btn-soft-light">
    ...
    <div class="row">
       <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
                <form action="{{url('review/update/'.$list[0]->rid)}}"  method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        
                        <div class="col-md-6 mt-3">
                            <label class="form-label" for="pname"><b>Product Name</b></label>
                            <input type="text" value="{{$list[0]->pname}}" class="form-control">
                        </div>
                        
                        <div class="col-md-6 mt-3">
                            <label class="form-label" for="pname"><b>User Name</b></label>
                            <input type="text" value="{{$list[0]->name}}" class="form-control">
                        </div>
                        
                        <div class="col-md-12 mt-3">
                            <label class="form-label" for="pname"><b>review</b></label>
                            <textarea class="form-control">{{$list[0]->review}}</textarea>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            <label class="form-label" for="pname"><b>Rating</b></label>
                            <input type="text" value="{{$list[0]->rating}}" class="form-control">
                        </div>
