...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
         ...
         <div class="card-body">
        <form action="{{url('subcategory/scategory')}}"  method="post" enctype="multipart/form-data">
            @csrf
         <div class="row">
                <div class="col-md-6 mt-3" >
                    ...
                    <select name="sid" id="from" class="form-control" required>
                        ...
                        @foreach($list as $row)
                        <option value="{{$row->id}},{{$row->cat_name}}">{{$row->cat_name}}</option>
                        @endforeach
                    </select>
                    @if($errors->has('sid'))
                ...
                <div class="col-md-12 mt-3" >
                    ...
                    <input type="text" class="form-control" name="scname"  placeholder="Category Name" required>
