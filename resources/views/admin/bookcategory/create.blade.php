        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <h4 class="card-title">Create Book Category</h4>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{url('bookcategory/bookcategorysave')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mt-3">
                                <label class="form-label" for="cname">Name<span style="color:red;">*</span></label>
