            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{url('bookcategory')}}" class="btn btn-link btn-soft-light">
...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
        <form action="{{url('bookcategory/catupdate/'.$list[0]->id)}}"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12 mt-3">
                    ...
                    <img src="{{asset('bookImage/'.$list[0]->image)}}" alt="" style="width:80px;">
                </div>
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">Category Name</label>
                    <input type="text" class="form-control" name="bookname" value="{{$list[0]->bookname}}" placeholder="Category Name" required>
                    @if($errors->has('bookname'))
                        <div class="form-error">{{ $errors->first('bookname') }}</div>
                    @endif
                </div>
                <div class="col-md-6 mt-3" >
