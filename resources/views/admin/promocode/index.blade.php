            ...
            <div class="row">
                <div class="col-md-12">
                                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="{{url('promocode/create_promocode')}}" class="btn btn-link btn-soft-light">
      ...
      <div class="card">
         <div class="card-header d-flex justify-content-between">
            <div class="header-title">
               <h4 class="card-title">View  Promocode</h4>
            </div>
         </div>
         <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <!--{{ $sd = $item->start_date}}-->
                     <tr>
                        ...
                        <td>{{$item->max_dis_amount}}</td>
                        <td>{{$item->repeat_usage}}</td>
                        <td>{{$item->no_of_repeat_usage}}</td>
                        ...
                        <td>
                            <a href="{{url('promocode/edit/'.$item->pcid)}}"> 
                            ...
                            <a href="{{url('promocode/delete/'.$item->pcid)}}" onclick="return confirm('Are you sure to Delete Permanently?')"> 
