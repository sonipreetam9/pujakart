...
<div class="row">
   <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
            <form action="{{url('promocode/promosave')}}"  method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">Promocode<span style="color:red;">*</span></label>
                    <input type="text" class="form-control" name="promocode"  placeholder="Promocode" required>
                ...
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">Start Date<span style="color:red;">*</span></label>
                    <input type="date" class="form-control" name="start_date"  placeholder="">
                </div>
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">End Date<span style="color:red;">*</span></label>
                    <input type="date" class="form-control" name="end_date"  placeholder="">
                </div>
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">No. Of Users</label>
                    <input type="number" class="form-control" name="no_of_user"  placeholder="">
                </div>
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">Minimum Order Amount<span style="color:red;">*</span></label>
                    <input type="number" class="form-control" name="min_amount"  placeholder="">
                </div>
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">Discount<span style="color:red;">*</span></label>
                    <input type="number" class="form-control" name="discount"  placeholder="">
                </div>
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">Discount Type<span style="color:red;">*</span></label>
                ...
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">Max Discount Amount<span style="color:red;">*</span></label>
                    <input type="text" class="form-control" name="max_dis_amount"  placeholder="">
                </div>
                <div class="col-md-6 mt-3" >
                    <label class="form-label" for="price">Repeat Usage<span style="color:red;">*</span></label>
                    <select name="repeat_usage" class="form-control" id="test" onchange="showDiv('hidden_div', this)" required>
                        <option value="">Select</option>
                ...
                <div class="col-md-6 mt-3"  id="hidden_div" style="display: none;"  >
                    <label class="form-label" for="price">No. Of Repeat Usage</label>
                    <input type="number" class="form-control" name="no_of_repeat_usage"  placeholder="">
                </div>
