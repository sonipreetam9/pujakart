                        ...
                        <div class="card shadow rounded-4 search-result slidedown">
                            <div class="card-body">
                                ...
                                <div class="card list-group list-group-flush list-group-custom mt-2">
                                    <a class="list-group-item list-group-item-action text-truncate" href="../documentation/doc-helperclass.html">
                                    ...
                                    <a class="list-group-item list-group-item-action text-truncate" href="../documentation/element-daterange.html">
                                    ...
                                    <a class="list-group-item list-group-item-action text-truncate" href="../documentation/element-imageinput.html">
                                    ...
                                    <a class="list-group-item list-group-item-action text-truncate" href="../documentation/plugin-table.html">
                                        <div class="fw-bold">DataTables for jQuery</div>
                                        <small class="text-muted">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</small>
                                    </a>
                                    <a class="list-group-item list-group-item-action text-truncate" href="../documentation/doc-setup.html">
                            ...
                            <div class="dropdown-menu rounded-4 shadow border-0 p-0" data-bs-popper="none">
                                <div class="card border-0">
                                    <div class="list-group list-group-custom" style="width: 200px;">
                                        <a href="javascript:void(0)" class="list-group-item"><span class="flag-icon flag-icon-gb me-2"></span>UK English</a>
                    ...
                    <li>
                        <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                            <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button" data-bs-toggle="dropdown">
                                <img class="avatar img-thumbnail rounded-circle shadow" src="{{url('assets/backend/images/profile_av.png')}}" alt="">
                            </a>
                            <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                                <div class="card border-0 w240">
                                    <div class="card-body border-bottom d-flex">
                                        <img class="avatar rounded-circle" src="{{url('assets/backend/images/profile_av.png')}}" alt="">
                                        <div class="flex-fill ms-3">
