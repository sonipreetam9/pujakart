    ...
    <div class="footer-body">
        <!-- <ul class="left-panel list-inline mb-0 p-0">
            ...
            <div class="right-panel">
                 ©<script>2023</script> <span>Pujakart</span>, Built With
                <span class="text-red">
                    <svg style="color:red;" class="icon-16" width="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </span> by <a href="https://amazingweb.design/" target="_blank">AmazingWeb.Design</a>.
            </div>
        </div>
    </footer>
    <!-- Footer Section End -->
...
<!-- Wrapper End-->
    ...
    <!-- Live Customizer end -->
        ...
        <?php $last = last(request()->segments()); if($last == 'product_order'||$last == 'searchcategory'){?>
            <!-- <script src="{{url('assets/js/core/chand.libs.min.js')}}"></script> -->
        <?php }else{ ?>
        ...
        <!-- Tour plugin Start -->
        <script src="{{url('assets/vendor/sheperd/dist/js/sheperd.min.js')}}"></script>
        <script src="{{url('assets/js/plugins/tour.js')}}" defer></script>
        <!-- Flatpickr Script -->
        <script src="{{url('assets/vendor/flatpickr/dist/flatpickr.min.js')}}"></script>
        <script src="{{url('assets/js/plugins/flatpickr.js')}}" defer></script>
        <!-- Select2 Script -->
        <script src="{{url('assets/js/plugins/select2.js')}}" defer></script>
        <!-- Slider-tab Script -->
        <script src="{{url('assets/js/plugins/slider-tabs.js')}}"></script>
        
        <!-- SwiperSlider Script -->
        <script src="{{url('assets/vendor/swiperSlider/swiper-bundle.min.js')}}"></script>
        <script src="{{url('assets/js/plugins/swiper-slider.js')}}" defer></script>
        <!-- Lodash Utility -->
        ...
        <!-- Widgetchart Script -->
        <script src="{{url('assets/js/charts/widgetchartsf700.js?v=1.0.1')}}" defer></script>
        <!-- Dashboard Script -->
        <script src="{{url('assets/js/charts/dashboardf700.js?v=1.0.1')}}" defer></script>
        <!-- qompacui Script -->
        <script src="{{url('assets/js/qompac-uif700.js?v=1.0.1')}}" defer></script>
        <script src="{{url('assets/js/sidebarf700.js?v=1.0.1')}}" defer></script>
        <script>
    ...
    <script>
    function sidebar(){
            //document.getElementById('sidebaricon').click();  
            //alert('yes');
    }
