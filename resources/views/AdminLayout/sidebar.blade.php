  ...
  <div class="sidebar p-2 py-md-3">
    <div class="container-fluid">
        ...
        <div class="title-text d-flex align-items-center mb-4 mt-1">
            <h4 class="sidebar-title mb-0 flex-grow-1"><span class="sm-txt">A</span><span>WD</span></h4>
        ...
        <div class="main-menu flex-grow-1">
            <ul class="menu-list">
                ...
                {{-- <li class="collapsed">
                    <a class="m-link active" data-bs-toggle="collapse" data-bs-target="#menu-Dashboard" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse show" id="menu-Dashboard">
                        ...
                        <li><a class="ms-link active" href="dashboard-ecommerce.html">eCommerce</a></li>
                        ...
                        <li><a class="ms-link" href="inventory/index.html" target="_blank">Inventory Management</a></li>
                        <li><a class="ms-link" href="job-portal/index.html" target="_blank">job Portal</a></li>
                        <li><a class="ms-link" href="real-estate/index.html" target="_blank">Real-Estate</a></li>
                        <li><a class="ms-link" href="restaurant/index.html" target="_blank">Restaurant</a></li>
                        <li><a class="ms-link" href="server/index.html" target="_blank">Server Analysis</a></li>
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="menu-Applications">
                        <li><a class="ms-link" href="{{url('bank/create')}}">Add New</a></li>
                        <li><a class="ms-link" href="{{url('bank')}}">View</a></li>
                ...
                {{-- <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="menu-Pages">
                        <li><a class="ms-link" href="page-profile.html">All Product</a></li>
                        <li><a class="ms-link" href="page-bookmark.html">Add New</a></li>
                        <li><a class="ms-link" href="page-timeline.html">Category</a></li>
                        <li><a class="ms-link" href="page-imagegallery.html">Tags</a></li>
                        <li><a class="ms-link" href="page-pricing.html">Attribute</a></li>
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="menu-Account">
                        <li><a class="ms-link" href="{{url('employee/create')}}">Add New</a></li>
                        <li><a class="ms-link" href="{{url('employee')}}">View </a></li>

                    </ul>
                </li>
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Hub" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="menu-Hub">
                        <li><a class="ms-link" href="javascript:void(0)">Search</a></li>

        
                    </ul>
                </li>
                <li>
                    <a class="m-link" href="{{url('customer')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
            ...
            <ul class="menu-list">
                <li class="divider py-2 lh-sm"><span class="small">RESOURCES</span><br> <small class="text-muted">Update your website</small></li>
                {{-- <li>
                ...
                <li>
                    <a class="m-link" href="{{url('logout_admin')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
